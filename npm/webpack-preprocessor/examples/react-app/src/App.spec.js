...
describe('App', () => {
  ...
  it('works', () => {
    ...
    cy.get('.todo').should('have.length', 4).contains('Meet friend for lunch').find('[data-cy=remove]').click()
  ...
  it('toggles an item', () => {
    cy.get('.todo').should('have.length', 3).contains('Learn about React').contains('button', 'Complete').click()
