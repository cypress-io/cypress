...
describe('ng-generate @cypress/schematic:specs-ct', () => {
  ...
  // TODO: fix this test. Currently it fails with the error:
  // `Error: ENOENT: no such file or directory, scandir`

  // it('should create cypress component tests alongside components', async () => {
  //   return schematicRunner.runSchematicAsync('specs-ct', { createSpecs: true, project: 'sandbox' }, appTree).toPromise().then((tree) => {
