...
export const isVite8 = (vite: Vite_7 | Vite_8): boolean => {
  // NOTE: on vite 8 release 8.0.0-beta.0 needs to be updated to 8.0.0
  // semver gte returns false because beta is NOT semver compatible with 8.0.0, meaning it can break between the last
  // beta release and the final release.
  const isVite8 = vite.version && semverGte(vite.version, '8.0.0-beta') || false

  debug('is vite 8 beta being used:', isVite8)
