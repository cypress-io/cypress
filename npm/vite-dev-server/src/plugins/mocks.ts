...
const debug = debugFn('cypress:vite-dev-server:plugins:mocks')

const MODULE_IMPORTER_IDENTIFIER = '__cypressModule'

const MODULE_CACHE_FILEPATH = path.resolve(__dirname, '../../client/CypressModuleCache.js')

export const CypressMocks = (
