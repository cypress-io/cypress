...
declare namespace legacyDevServer {
  export interface CypressBabelDevServerConfig {
    /**
   ...
   */
  export function defineDevServerConfig(babelDevServerConfig: CypressBabelDevServerConfig): CypressBabelDevServerConfig
