...
Cypress has some added functionality for quickly referring back to past subjects called [Aliases](/guides/core-concepts/aliases-and-references.html). It looks something like this:
