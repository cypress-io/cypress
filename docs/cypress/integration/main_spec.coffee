...
describe "Documentation", ->
  ...
  context "Extra scripts and styles", ->
    it "has CypressDocs set", ->
      cy.visit("/")
      cy.window()
        .its("CypressDocs")
        .should("equal", "CypressDocs")
  ...
  context "Search", ->
    ...
    describe "Intro to Cypress", ->
      ...
      # TODO needs fixing, why is sidebar missing only on this page?!
      it.skip "has navigation sidebar", ->
