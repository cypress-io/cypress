...
import { ParentComponent } from './components/legacy/modules/parent.component'
import { ChildComponent } from './components/legacy/modules/child.component'

import { WithDirectivesComponent } from './components/legacy/with-directives.component'
import { ButtonOutputComponent } from './components/legacy/button-output.component'
import { CounterComponent } from './components/counter.component'
import { ProjectionComponent } from './components/legacy/projection.component'

import { ChildProvidersComponent } from './components/legacy/providers/child-providers.component'
import { ParentProvidersComponent } from './components/legacy/providers/parent-providers.component'
import { ChildProvidersService } from './components/legacy/providers/child-providers.service'
import { AnotherChildProvidersComponent } from './components/legacy/providers/another-child-providers.component'
...
import { ComponentProviderComponent, MessageService } from './components/legacy/providers/component-provider.component'
...
describe('angular mount', () => {
  describe('legacy', () => {
    ...
    describe('@Input() decorators', () => {
      it('detects changes via setInput method', () => {
...
context('assets', () => {
  ...
  it('can load root relative css "url()" assets', () => {
