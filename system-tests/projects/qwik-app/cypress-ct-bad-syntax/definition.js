...
const solidDep = {
    type: "cypress-ct-bad-syntax",
    name: "Solid",
    package: "cypress-ct-bad-syntax",
    installer: "scypress-ct-bad-syntax",
...
const solidVitePlugin = {
    ...
    description: "A simple integration to run solid-bad with vite",
