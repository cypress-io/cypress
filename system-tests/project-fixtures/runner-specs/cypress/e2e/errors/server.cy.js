...
// TODO(origin): testIsolation 'on' causes cy.route to fail, appears to be related to visiting about:blank
describe('cy.server', { defaultCommandTimeout: 0, testIsolation: 'off' }, () => {
