...
export const CYPRESS_LOCAL_FLAKY_PROTOCOL_STUB = buildStub('protocolStubWithNonFatalError.ts')

export const CYPRESS_LOCAL_FLAKY_PROTOCOL_STUB_COMPRESSED = gzipSync(CYPRESS_LOCAL_FLAKY_PROTOCOL_STUB)

export const CYPRESS_LOCAL_FLAKY_PROTOCOL_STUB_HASH = hash(CYPRESS_LOCAL_FLAKY_PROTOCOL_STUB)

export const CYPRESS_LOCAL_FLAKY_PROTOCOL_STUB_SIGN = sign(CYPRESS_LOCAL_FLAKY_PROTOCOL_STUB)
