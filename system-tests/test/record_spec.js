    ...
    it('continues', function () {
      ...
      return systemTests.exec(this, {
        ...
        expect(artifactReport?.protocol?.error).to.equal(
          'Failed to upload Test Replay after 1 attempts. Errors: http://localhost:1234/capture-protocol/upload/?x-amz-credential=XXXXXXXX&x-amz-signature=XXXXXXXXXXXXX responded with 500 Internal Server Error',
        )
      })
    })
  })
