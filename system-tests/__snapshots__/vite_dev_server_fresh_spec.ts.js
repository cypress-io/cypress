...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  > Module Error (from src/AppCompilationError.cy.jsx):
Transform failed with 1 error:
/foo/bar/.projects/vite2.8.6-react/src/AppCompilationError.cy.jsx:9:0: ERROR: Expected ")" but found "}"
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  > Module Error (from src/AppCompilationError.cy.jsx):
Transform failed with 1 error:
/foo/bar/.projects/vite2.9.1-react/src/AppCompilationError.cy.jsx:9:0: ERROR: Expected ")" but found "}"
