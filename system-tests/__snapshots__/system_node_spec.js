...
Deprecation Warning: \`nodeVersion\` is currently set to \`system\` in the \`cypress.json\` configuration file. As of Cypress v9 the default behavior of \`nodeVersion\` has changed to always use the version of Node used to start cypress via the cli.
...
Deprecation Warning: \`nodeVersion\` is currently set to \`bundled\` in the \`cypress.json\` configuration file. As of Cypress v9 the default behavior of \`nodeVersion\` has changed to always use the version of Node used to start cypress via the cli. When \`nodeVersion\` is set to \`bundled\`, Cypress will use the version of Node bundled with electron. This can cause problems running certain plugins or integrations. 
