...
Fix the error in your code and re-run your tests.
  ...
  - Video - Done Uploading 1 kB 1/1 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/videos/record_error.cy.js.mp4
...
Because this error occurred during a \`before each\` hook we are skipping the remaining tests in the current suite: \`record fails\`
  ...
  - Video - Done Uploading 1 kB 1/2 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/videos/record_fail.cy.js.mp4
  - Screenshot - Done Uploading 1 kB 2/2 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/screenshots/record_fail.cy.js/record fails -- fails 1 -- before each hook (failed).png
...
plugin stdout
  ...
  - Screenshot - Done Uploading 1 kB 1/1 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/screenshots/record_pass.cy.js/yay it passes.png
...
We dynamically generated a new test to display this failure.
  ...
  - Video - Done Uploading 1 kB 1/2 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/videos/record_uncaught.cy.js.mp4
  - Screenshot - Done Uploading 1 kB 2/2 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/screenshots/record_uncaught.cy.js/An uncaught error was detected outside of a test (failed).png
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  - Video - Failed Uploading 1/2 after Xm, Ys ZZms /XXX/XXX/XXX/cypress/videos/record_pass.cy.js.mp4 - 500 - "Internal Server Error"
  - Screenshot - Failed Uploading 2/2 after Xm, Ys ZZms /XXX/XXX/XXX/cypress/screenshots/record_pass.cy.js/yay it passes.png - 500 - "Internal Server Error"
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  - Screenshot - Done Uploading 1 kB 1/2 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/screenshots/record_pass.cy.js/yay it passes.png
  - Test Replay - Done Uploading 1 kB 2/2 in Xm, Ys ZZms
...
https://on.cypress.io/renderer-process-crashed
  ...
  - Test Replay - Done Uploading 1 kB 1/1 in Xm, Ys ZZms
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  - Screenshot - Done Uploading 1 kB 1/2 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/screenshots/record_pass.cy.js/yay it passes.png
  - Test Replay - Failed Uploading 2/2 after Xm, Ys ZZms - Spec recording too large: db is 1024 bytes, limit is 200 bytes
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  - Screenshot - Done Uploading 1 kB 1/2 in Xm, Ys ZZms /XXX/XXX/XXX/cypress/screenshots/record_pass.cy.js/yay it passes.png
  - Test Replay - Failed Uploading 2/2 after Xm, Ys ZZms - Internal Server Error
