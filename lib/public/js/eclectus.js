...
(function() {
  this.App = (function(Backbone, Marionette) {
    ...
    App.on("before:start", function(options) {
      ...
      return App.config = App.request("new:config:entity", options);
    });
  ...
  this.App.module("NavApp.List", function(List, App, Backbone, Marionette, $, _) {
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function() {
        var config, navs, view;
        navs = App.request("nav:entities");
        config = App.request("app:config:entity");
        view = this.getView(navs, config);
        return this.show(view);
      };

      Controller.prototype.getView = function(navs, config) {
