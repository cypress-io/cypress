...
(function() {
  Eclectus.Command = (function($, _) {
    ...
    Command = (function() {
      ...
      Command.prototype.clone = function(klass) {
        var instance;
        instance = new klass(this.document, this.channel, this.runnable);
...
(function() {
  ...
  Eclectus.Dom = (function($, _, Eclectus) {
    var Dom, jQueryMethods, traversalMethods;
    ...
    _.each(traversalMethods, function(method) {
      return Dom.prototype[method] = function() {
        ...
        dom.emit({
          selector: dom.selector || arguments[0].toString(),
          el: dom.$(dom.selector),
          method: method
        });
        return dom;
...
(function() {
  ...
  this.App.module("Utilities", function(Utilities, App, Backbone, Marionette, $, _) {
    var API, Reporter, assert, assertProto, df, emit, expect, overloadChaiAssertions, overloadMochaRunnableEmit, overloadMochaRunnerUncaught, uncaught;
    df = null;
