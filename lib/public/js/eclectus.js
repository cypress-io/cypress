...
(function() {
  ...
  this.App.module("TestCommandsApp", function(TestCommandsApp, App, Backbone, Marionette, $, _) {
    ...
    router = new Router;
    return App.commands.setHandler("list:test:commands", function(commands, region) {
      return router.to("list", {
        commands: commands,
        region: region
      });
...
(function() {
  ...
  this.App.module("TestCommandsApp.List", function(List, App, Backbone, Marionette, $, _) {
    List.Command = (function(_super) {
      ...
      Command.prototype.template = "test_commands/list/command";
    ...
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.insertChildViews = function(runner, model) {
        return model.trigger("get:layout:view", (function(_this) {
          return function(layout) {
            ...
            if (model.is("test")) {
              return App.execute("list:test:commands", model.get("commands"), layout.commandsRegion);
            } else {
              region = layout.runnablesRegion;
              if (region.currentView && runner.hasChosen()) {
                return;
              }
      ...
      Controller.prototype.createRunnableListeners = function(runner, runnables, model) {
        ...
        return this.listenTo(model, "model:double:clicked", function() {
          runnables.each(function(runnable) {
...
window.JST["backbone/apps/test_commands/list/templates/command"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<span class="command-method">');
      ...
      __out.push('\n<i class="fa fa-search fa-flip-horizontal pull-right"></i>');
