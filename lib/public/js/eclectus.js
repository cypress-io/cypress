...
(function() {
  ...
  this.App.module("TestPanelsApp", function(TestPanelsApp, App, Backbone, Marionette, $, _) {
    ...
    return App.commands.setHandler("show:panel", function(panel, region) {
    ...
    return DOM.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(this.layout, "show", function() {
          return this.domContentRegion();
        });
        return this.show(this.layout);
      };

      Controller.prototype.domContentRegion = function() {
        var domView;
        domView = this.getDomView();
        return this.show(domView, {
          region: this.layout.domContentRegion
        });
      };

      Controller.prototype.getDomView = function() {
...
(function() {
  ...
  this.App.module("TestPanelsApp.DOM", function(DOM, App, Backbone, Marionette, $, _) {
    ...
    DOM.Row = (function(_super) {
      ...
      Row.prototype.template = "test_panels/dom/_row";

      return Row;

    })(App.Views.ItemView);
    return DOM.Content = (function(_super) {
      ...
      Content.prototype.tagName = "ul";

      Content.prototype.childView = DOM.Row;
    ...
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(panels, "change:chosen", function(model, value, options) {
          ...
          return this.panelRegion(model, value, regions);
        });
      ...
      Controller.prototype.panelRegion = function(panel, show, regions) {
        var region;
        region = this.getRegion(panel.get("name"), regions);
        if (show) {
          return App.execute("show:panel", panel, region);
        } else {
          return region.empty();
        }
      };
    ...
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(runner, "load:iframe", function(iframe, options) {
          if (runner.hasChosen()) {
            return runnables.eachModel(function(model, runnable) {
              if (model.isChosen()) {
                model.reset();
                return this.resetRunnables(runnables, runnable);
              }
            });
          } else {
            root.reset();
...
window.JST["backbone/apps/test_panels/dom/templates/_row"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<span class="content-title">can be nested</span>\n<span class="content-msg">Found</span>');
