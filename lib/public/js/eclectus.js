...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.RunnableCollection = (function(_super) {
      ...
      RunnableCollection.prototype.initialize = function() {
    ...
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(runner, "test:end", function(test) {
          ...
          return test.parent.model.updateState();
        });
      ...
      Controller.prototype.addRunnable = function(root, runnables, runnable, type) {
        ...
        if (_ref = runnable.parent, __indexOf.call(runnables, _ref) >= 0) {
          return runnable.parent.model.addRunnable(runnable, type);
        } else {
          return root.addRunnable(runnable, type);
        }
      };
  ...
  this.App.module("TestSpecsApp.List", function(List, App, Backbone, Marionette, $, _) {
    List.Test = (function(_super) {
      ...
      Test.prototype.stateChanged = function(model, value, options) {
        this.$el.removeClass("processing failed passed").addClass(value);
        if (value === "passed") {
          this.checkDuration();
        }
        if (value === "failed") {
    ...
    List.Suite = (function(_super) {
      ...
      Suite.prototype.stateChanged = function(model, value, options) {
        return this.$el.removeClass("processing failed passed").addClass(value);
      };

      return Suite;

    })(App.Views.CompositeView);
    List.Suites = (function(_super) {
