  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.Runner = (function(_super) {
      ...
      Runner.prototype.hasChosen = function() {
        return !!this.get("chosenId");
      };

      Runner.prototype.setChosenId = function(id) {
        if (this.get("chosenId") === id) {
          this.unset("chosenId");
        } else {
          this.set("chosenId", id);
        }
        return this.triggerLoadIframe(this.iframe);
      };
      ...
      Runner.prototype.getGrep = function() {
        var id;
        if (id = this.get("chosenId")) {
          return new RegExp(this.escapeId("[" + id + "]"));
        } else {
          return /.*/;
        }
      };
...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.Suite = (function(_super) {
      ...
      Suite.prototype.defaults = function() {
        return {
          state: "processing"
        };
      };
      ...
      Suite.prototype.anyAreProcessing = function(states) {
        return _(states).any(function(state) {
          return state === "processing";
        });
      };

      Suite.prototype.anyAreFailed = function(states) {
        return _(states).any(function(state) {
          return state === "failed";
        });
      };

      Suite.prototype.allArePassed = function(states) {
        return _(states).all(function(state) {
          return state === "passed";
        });
      };

      Suite.prototype.updateState = function() {
        var state, states;
        states = this.get("tests").pluck("state");
        state = (function() {
          switch (false) {
            case !this.anyAreProcessing(states):
              return "processing";
      ...
      Suite.prototype.unchooseTests = function() {
        return this.get("tests").invoke("unchoose");
      };
    ...
    Entities.SuitesCollection = (function(_super) {
      ...
      SuitesCollection.prototype.initialize = function() {
      ...
      SuitesCollection.prototype.unchooseTests = function() {
        return this.invoke("unchooseTests");
      };

      SuitesCollection.prototype.resetTestsOrClearOne = function() {
        var chosen, test, tests;
        if (chosen = this.getFirstChosen()) {
          return chosen.get("tests").invoke("reset");
        } else {
          tests = this.reduce(function(memo, suite) {
            return memo = memo.concat(suite.get("tests").models);
          }, []);
          test = tests.find(function(test) {
...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.Test = (function(_super) {
      ...
      Test.prototype.isSlow = function() {
        return this.get("duration") > this._slow;
      };

      Test.prototype.timedOut = function() {
        return this.get("duration") > this._timeout;
      };
      ...
      Test.prototype.removeOriginalError = function() {
        return delete this.originalError;
      };

      Test.prototype.setResults = function(test) {
        var attrs;
        attrs = {
          state: test.pending ? "pending" : test.state,
          duration: test.duration
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(runner, "load:iframe", (function(_this) {
          return function(iframe) {
            return _this.loadIframe(view, runner, iframe);
          };
        })(this));
        return this.show(view);
      };
    ...
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(runner, "load:iframe", function(iframe, options) {
          if (runner.hasChosen()) {
            return runnables.eachModel(function(model) {
              if (model.isChosen()) {
                return model.reset();
              }
            });
      ...
      Controller.prototype.addRunnable = function(root, runnables, runnable, type) {
        var existingRunnable, _ref;
        existingRunnable = _(runnables).find(function(item) {
          return item.cid === runnable.cid;
        });
        if (existingRunnable) {
          runnables.splice(_(runnables).indexOf(existingRunnable), 1);
        }
      ...
      Controller.prototype.createRunnableListeners = function(runner, runnables, model) {
        ...
        return this.listenTo(model, "model:clicked", (function(_this) {
          return function() {
            ...
            return runner.setChosenId(model.id);
          };
        })(this));
      };

      Controller.prototype.getRunnableView = function(root) {
        return new List.Runnable({
          model: root
        });
      };
...
(function() {
  ...
  this.App.module("TestSpecsApp.List", function(List, App, Backbone, Marionette, $, _) {
    List.Test = (function(_super) {
      ...
      Test.prototype.mouseover = function(e) {
        e.stopPropagation();
        return this.$el.addClass("hover");
      };

      Test.prototype.mouseout = function(e) {
        e.stopPropagation();
        return this.$el.removeClass("hover");
      };

      Test.prototype.chosenChanged = function(model, value, options) {
      ...
      Test.prototype.checkDuration = function() {
      ...
      Test.prototype.checkTimeout = function() {
      ...
      Test.prototype.testClicked = function(e) {
        e.stopPropagation();
    ...
    List.Suite = (function(_super) {
      ...
      Suite.prototype.events = {
        "mouseover": "mouseover",
        "mouseout": "mouseout",
        "click": "suiteClicked"
      };

      Suite.prototype.modelEvents = {
        "change:state": "stateChanged",
        "change:chosen": "chosenChanged"
      };

      Suite.prototype.getChildView = function(model) {
      ...
      Suite.prototype.mouseover = function(e) {
        e.stopPropagation();
        return this.$el.addClass("hover");
      };

      Suite.prototype.mouseout = function(e) {
        e.stopPropagation();
        return this.$el.removeClass("hover");
      };
      ...
      Suite.prototype.chosenChanged = function(model, value, options) {
        return this.$el.toggleClass("active", value);
      };

      Suite.prototype.onBeforeRender = function() {
        return this.$el.addClass(this.model.get("state"));
      };

      Suite.prototype.stateChanged = function(model, value, options) {
        return this.$el.removeClass("processing pending failed passed").addClass(value);
      };

      Suite.prototype.suiteClicked = function(e) {
        e.stopPropagation();
        return this.model.trigger("model:clicked");
      };
    ...
    return List.Runnable = (function(_super) {
      __extends(Runnable, _super);
      ...
      Runnable.prototype.tagName = "ul";

      Runnable.prototype.id = "specs-container";

      Runnable.prototype.getChildView = function(model) {
        switch (model.get("type")) {
          case "suite":
            return List.Suite;
          case "test":
...
(function() {
  ...
  this.App.module("TestStatsApp.Show", function(Show, App, Backbone, Marionette, $, _) {
    return Show.Stats = (function(_super) {
      ...
      Stats.prototype.template = "test_stats/show/stats";
...
window.JST["backbone/apps/test_stats/show/templates/stats"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
