...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.CommandsCollection = (function(_super) {
      ...
      CommandsCollection.prototype.lastParentCommandIsNot = function(command) {
        var model, _i, _ref;
        _ref = this.models;
      ...
      CommandsCollection.prototype.handleParent = function(command, parent, cb) {
        if (parent = this.parentExistsFor(parent)) {
          if (this.lastParentCommandIsNot(parent)) {
    ...
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(commandsView, "childview:command:mouseenter", function(iv, args) {
          return runner.highlightEl(args.model);
        });
        this.listenTo(commandsView, "childview:command:mouseleave", function(iv, args) {
          return runner.highlightEl(args.model, false);
        });
  ...
  this.App.module("TestIframeApp.Show", function(Show, App, Backbone, Marionette, $, _) {
    return Show.Iframe = (function(_super) {
      ...
      Iframe.prototype.highlightEl = function(el, options) {
        ...
        if (!this.reverted && !options.init) {
          return this.iframe.contents().find("[data-highlight-el='" + options.id + "']").remove();
        }
        if (options.dom) {
          dom = options.dom;
        ...
        return el.each((function(_this) {
          return function(index, el) {
            ...
            if (!el.length || dimensions.width === 0 || dimensions.height === 0) {
              return;
            }
