  ...
  Eclectus.Command = (function($, _) {
    ...
    Command = (function() {
      ...
      Command.prototype.emit = function(obj) {
        ...
        _.defaults(obj, {
          parent: (_ref = this.parent) != null ? _ref.id : void 0,
          length: this.length,
...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.CommandsCollection = (function(_super) {
      ...
      CommandsCollection.prototype.lastCommandIsNot = function(command) {
      ...
      CommandsCollection.prototype.handleParent = function(command, parent) {
        var df;
        df = $.Deferred();
        if (parent = this.parentExistsFor(parent)) {
          if (this.lastCommandIsNot(parent)) {
            parent = this.insertParent(parent);
          }
      ...
      CommandsCollection.prototype.addDom = function(attrs) {
        ...
        command.dom = dom;
        command.el = el;
        this.handleParent(command, attrs.parent);
        return command;
      };
      ...
      CommandsCollection.prototype.addXhr = function(attrs) {
        ...
        command.xhr = xhr;
        command.dom = dom;
        this.handleParent(command, attrs.parent).done(function() {
    ...
    return Show.Iframe = (function(_super) {
      ...
      Iframe.prototype.revertToDom = function(dom, options) {
        ...
        if (options.highlight) {
          return this.highlight(dom, options.el, options.attr);
        }
      };
      ...
      Iframe.prototype.highlight = function(dom, el, attr) {
        var found;
        found = dom.find("[" + attr + "]");
        return found.each((function(_this) {
