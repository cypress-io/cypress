(function() {
  window.Eclectus = (function($, _) {
    ...
    Eclectus = (function() {
      ...
      Eclectus.scope = function(instance) {
        instance.unscope = (function(_this) {
          return function() {
            return _this.patch(_(runnable).pick("runnable", "channel", "document"));
          };
        })(this);
        return this.patch(instance);
      };

      Eclectus.instantiate = function(argsOrInstance) {
        var dom, obj;
        obj = dom = argsOrInstance;
        if (_.isFunction(dom) && dom instanceof Eclectus.DOM) {
          return dom;
        }
        dom = new Eclectus.Dom(obj.document, obj.channel, obj.runnable);
        return dom.scope = _.partial(this.scope, dom);
      };
...
(function() {
  Eclectus.Dom = (function($, _) {
    var Dom;
    Dom = (function() {
      function Dom(document, channel, runnable, prevObject) {
