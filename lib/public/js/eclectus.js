...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.CommandsCollection = (function(_super) {
      ...
      CommandsCollection.prototype.getParentIndex = function(id) {
        var parent;
        parent = this.get(id);
        if (parent) {
      ...
      CommandsCollection.prototype.addXhr = function(attrs) {
        ...
        command.dom = dom;
        if (attrs.parent) {
          command.index = this.getParentIndex(attrs.parent);
        }
        this.insertParents(command, attrs.parent, {
          "if": function(parent, cmd) {
      ...
      CommandsCollection.prototype.add = function(attrs, type, runnable) {
        var command, options, opts;
        try {
          options = type;
          if (attrs instanceof Entities.Command) {
            return CommandsCollection.__super__.add.call(this, attrs, options);
          }
        } catch (_error) {}
        if (_.isEmpty(attrs)) {
          return;
        ...
        opts = {};
        if (command.index) {
          opts.at = command.index;
        }
        return CommandsCollection.__super__.add.call(this, command, opts);
      };
