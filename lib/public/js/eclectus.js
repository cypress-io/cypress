  ...
  window.Eclectus = (function($, _) {
    ...
    methods = {
      find: function(obj, el) {
        ...
        return obj.channel.trigger("dom", obj.runnable, {
          el: dom.$(el),
...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.DomsCollection = (function(_super) {
      ...
      DomsCollection.prototype.getMsg = function(el, node) {
        var a, found;
        found = el.length;
        a = ["'" + node + "'"];
        a.push(found ? "found" : "not found");
        return a.join(" ");
      };
      ...
      DomsCollection.prototype.add = function(attrs, runnable) {
        ...
        this.el = attrs.el, this.dom = attrs.dom;
        attrs = _(attrs).pick("method");
        _.extend(attrs, {
          node: this.el.prop("nodeName").toLowerCase(),
          title: runnable.originalTitle(),
          testId: runnable.cid
        });
        attrs.msg = this.getMsg(this.el, attrs.node);
        return DomsCollection.__super__.add.call(this, attrs);
      };
    ...
    return DOM.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(this.layout, "show", function() {
          return this.domContentRegion(doms);
        });
        return this.show(this.layout);
      };

      Controller.prototype.domContentRegion = function(doms) {
        var domView;
...
window.JST["backbone/apps/test_panels/dom/templates/_dom"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<span class="content-title">');
