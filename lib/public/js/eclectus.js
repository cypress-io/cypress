...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.CommandsCollection = (function(_super) {
      ...
      CommandsCollection.prototype.lastParentCommandIsNot = function(parent, command) {
        var model, _i, _ref;
        _ref = this.models;
      ...
      CommandsCollection.prototype.insertParents = function(command, parentId, cb) {
        var parent;
        if (parent = this.parentExistsFor(parentId)) {
          if (this.lastParentCommandIsNot(parent, command)) {
            if (parent.hasParent()) {
              this.insertParents(parent, parent.parent.id);
            }
      ...
      CommandsCollection.prototype.addXhr = function(attrs) {
        ...
        command.xhr = xhr;
        command.dom = dom;
        this.insertParents(command, attrs.parent, function() {
...
(function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.FilesCollection = (function(_super) {
      ...
      FilesCollection.prototype.comparator = function(a, b) {
        if (a.get("children").length === 0) {
          return 1;
        }
        return this.sortByName(a, b);
      };

      FilesCollection.prototype.sortByName = function(a, b) {
