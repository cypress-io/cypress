  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Container = (function() {
      ...
      Container.prototype.removeOldModels = function() {
        var ids, index, runnable, _i, _ref, _ref1, _results;
        ids = this.pluck("id");
        _ref = this.previousRunnables;
        _results = [];
        for (index = _i = _ref.length - 1; _i >= 0; index = _i += -1) {
          runnable = _ref[index];
          if (_ref1 = runnable.id, __indexOf.call(ids, _ref1) < 0) {
            runnable.remove();
            _results.push(this.previousRunnables.splice(index, 1));
          } else {
    ...
    _.each(["each", "pluck", "indexOf"], function(method) {
    ...
    Entities.Runner = (function(_super) {
      ...
      Runner.prototype.setTestRunner = function(runner) {
        ...
        return this.runner.runSuite = _.wrap(this.runner.runSuite, function(runSuite, rootSuite, fn) {
          ...
          this.grep(runner.getGrep(rootSuite));
          return runSuite.call(this, rootSuite, fn);
        });
      };

      Runner.prototype.iterateThroughRunnables = function(runnable) {
        return _.each([runnable.tests, runnable.suites], (function(_this) {
          return function(array) {
            return _.each(array, function(runnable) {
              return _this.generateId(runnable);
            });
          };
        })(this));
      };

      Runner.prototype.generateId = function(runnable) {
        var count, event, grep, runner, _ref;
      ...
      Runner.prototype.isDefaultGrep = function(str) {
        return str.toString() === "/.*/";
      };
      ...
      Runner.prototype.runIframeSuite = function(iframe, contentWindow) {
        ...
        if (!this.isDefaultGrep(this.options.grep)) {
          this.trigger("exclusive:test");
        }
  ...
  this.App.module("TestSpecsApp.List", function(List, App, Backbone, Marionette, $, _) {
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(runner, "exclusive:test after:run", function() {
    ...
    (function() {
      ...
      if (this.response != null) {
        ...
        if (this.status != null) {
          ...
          __out.push(__sanitize(this.status === 200 ? 'successful' : 404 ? 'bad' : ''));
