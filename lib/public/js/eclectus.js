...
(function() {
  ...
  this.App.module("Utilities", function(Utilities, App, Backbone, Marionette, $, _) {
    var API, Reporter, assert, df, emit, overloadChaiAssertions, overloadMochaRunnableEmit, overloadMochaRunnerUncaught, uncaught;
    df = null;
    ...
    overloadChaiAssertions = function(Ecl) {
      return chai.use(function(_chai, utils) {
        return _chai.Assertion.prototype.assert = _.wrap(assert, function() {
