...
(function() {
  ...
  this.App.module("Utilities", function(Utilities, App, Backbone, Marionette, $, _) {
    var API;
    API = {
      getRunnableContainer: function() {
        var container;
        container = [];
        _(["each", "find"]).each(function(method) {
        ...
        container.add = function(runnable) {
          this.push(runnable);
          return this._models.push(runnable.model);
        };
        container.remove = function(runnable) {
          var index, modelIndex;
          index = _.indexOf(this, runnable);
          this.splice(index, 1);
          modelIndex = _.indexOf(this._models, runnable.model);
          return this._models.splice(modelIndex, 1);
        };
    ...
    return App.reqres.setHandler("runnable:container", function() {
      return API.getRunnableContainer();
    });
  });
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.Runnable = (function(_super) {
      ...
      Runnable.prototype.addRunnable = function(runnable, type) {
        ...
        return this.get("children").addRunnable(runnable, type, indent);
      };
    ...
    Entities.RunnableCollection = (function(_super) {
      ...
      RunnableCollection.prototype.addRunnable = function(runnable, type, indent) {
        var attrs;
        attrs = {
          title: runnable.originalTitle(),
          id: runnable.cid,
...
(function() {
  ...
  this.App.module("TestSpecsApp.List", function(List, App, Backbone, Marionette, $, _) {
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        var commands, root, runnables, runnablesView, runner, suites;
        runner = options.runner;
        ...
        this.listenTo(runner, "load:iframe", function(iframe, options) {
          if (runner.hasChosen()) {
            return runnables.each((function(_this) {
      ...
      Controller.prototype.addRunnable = function(root, runnables, runnable, type) {
        ...
        this.createRunnableListeners(runnable.model);
        return this.insertChildViews(runnable.model);
      };

      Controller.prototype.insertChildViews = function(model) {
        return model.trigger("get:layout:view", (function(_this) {
          return function(layout) {
            var contentView, runnablesView;
...
(function() {
  ...
  this.App.module("TestSpecsApp.List", function(List, App, Backbone, Marionette, $, _) {
    List.Runnable = (function(_super) {
      ...
      Runnable.prototype.childView = List.RunnableLayout;
      ...
      Runnable.prototype.initialize = function() {
        ...
        return console.info("@collection", this.collection);
      };
      ...
      Runnable.prototype.openChanged = function(model, value, options) {
        this.hideOrShowRunnableContent();
        if (this.model.is("suite")) {
          return this.changeIconDirection();
        }
      };

      Runnable.prototype.hideOrShowRunnableContent = function() {
        var el;
        el = this.model.is("test") ? this.ui.log : this.ui.runnables;
        return el.toggleClass("hidden");
      };

      Runnable.prototype.changeIconDirection = function() {
        var klass;
        klass = this.model.get("open") ? "right" : "down";
        return this.ui.icon.removeClass().addClass("fa fa-caret-" + klass);
      };

      Runnable.prototype.dblClicked = function(e) {
        e.stopPropagation();
      ...
      Runnable.prototype.onRender = function() {
        return this.applyIndent();
      };

      Runnable.prototype.applyIndent = function(state) {
        var indent;
    ...
    List.RunnableContent = (function(_super) {
      ...
      RunnableContent.prototype.errorChanged = function(model, value, options) {
        value || (value = "");
        return this.ui.pre.text(value);
      };
    ...
    List.RunnableLayout = (function(_super) {
      ...
      RunnableLayout.prototype.checkDuration = function() {
        if (!this.model.isSlow()) {
          return;
        }
        return this.ui.label.addClass("label-primary").text(this.model.get("duration") + "ms");
      ...
      RunnableLayout.prototype.checkTimeout = function() {
        if (!this.model.timedOut()) {
          return;
        }
        return this.ui.label.addClass("label-danger").text("Timed Out");
...
window.JST["backbone/apps/test_specs/list/templates/_test_layout"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<div class="runnable-wrapper">\n  <div class="runnable-content-region"></div>\n  <div class="runnable-commands-region"></div>\n</div>');
