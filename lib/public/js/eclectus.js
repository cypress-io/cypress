  ...
  window.Eclectus = (function($, _) {
    ...
    methods = {
      ...
      within: function(obj, el, fn) {
        ...
        command = Eclectus.createCommand(obj);
        return command.within(el, fn);
      },
      server: function(obj) {
        var server;
        this.sandbox._server = server = obj.contentWindow.sinon.fakeServer.create();
        this.sandbox.server = new Eclectus.Xhr(server, obj.channel, obj.runnable);
    ...
    Eclectus = (function() {
      ...
      Eclectus.scope = function(command) {
        command.unscope = (function(_this) {
          return function() {
            return _this.patch(_(command).pick("runnable", "channel", "document"));
          };
        })(this);
        return this.patch(command);
      };

      Eclectus.createCommand = function(argsOrInstance) {
        var command, obj;
        obj = command = argsOrInstance;
        try {
          if (command instanceof Eclectus.Command) {
            return command;
          }
        } catch (_error) {}
        command = new Eclectus.Command(obj.contentWindow.document, obj.channel, obj.runnable);
        command.scope = _.bind(this.scope, this, command);
        return command;
      };
  ...
  Eclectus.Command = (function($, _) {
    ...
    Command = (function() {
      function Command(document, channel, runnable) {
        ...
        this.instanceId = _.uniqueId("commandInstance");
      }
      ...
      Command.prototype.find = function(el) {
        var body;
      ...
      Command.prototype.within = function(el, fn) {
        var body;
        this.$el = this.$el ? this.$el.find(el) : this.$(el);
        this.selector = this.$el.selector;
        body = this.$("body").clone(true, true);
      ...
      Command.prototype.type = function(sequence, options) {
        var body;
        if (options == null) {
          options = {};
        }
      ...
      Command.prototype.pauseRunnable = function() {
  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.CommandsCollection = (function(_super) {
      ...
      CommandsCollection.prototype.insertParent = function(parent) {
        var clone;
        clone = parent.clone();
        _.each(["el", "dom", "parent"], function(prop) {
      ...
      CommandsCollection.prototype.addXhr = function(attrs) {
        var command, response, xhr;
        xhr = attrs.xhr, response = attrs.response;
        attrs = _(attrs).omit("xhr");
        if (command = this.parentExistsFor(attrs.instanceId)) {
...
(function() {
  ...
  this.App.module("TestCommandsApp.List", function(List, App, Backbone, Marionette, $, _) {
    List.Xhr = (function(_super) {
      ...
      Xhr.prototype.template = "test_commands/list/_xhr";

      Xhr.prototype.ui = {
        response: ".command-response"
      };

      Xhr.prototype.modelEvents = {
        "change:response": "render"
      };

      Xhr.prototype.events = {
        "click": "clicked",
        "click @ui.response": "responseClicked"
      };

      Xhr.prototype.clicked = function(e) {
        e.stopPropagation();
        return console.log(this.model.xhr);
      };

      Xhr.prototype.responseClicked = function(e) {
        var response;
        e.stopPropagation();
    ...
    List.Dom = (function(_super) {
      ...
      Dom.prototype.template = "test_commands/list/_dom";
      ...
      Dom.prototype.clicked = function(e) {
        e.stopPropagation();
        return console.log(this.model.el);
      };
    ...
    return List.Commands = (function(_super) {
      ...
      Commands.prototype.getChildView = function(command) {
