  ...
  this.App.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Config = (function(_super) {
      ...
      Config.prototype.setConfig = function(attr, value, options) {
        ...
        return localStorage.setItem(attr, value);
      };
...
(function() {
  ...
  this.App.module("TestPanelsApp", function(TestPanelsApp, App, Backbone, Marionette, $, _) {
    ...
    router = new Router;
    return App.commands.setHandler("list:test:panels", function(region, runner) {
      return router.to("list", {
        region: region,
        runner: runner
      });
  ...
  this.App.module("NavApp.List", function(List, App, Backbone, Marionette, $, _) {
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(config, "list:test:panels", function(runner) {
          return this.panelsRegion(runner);
        });
      ...
      Controller.prototype.panelsRegion = function(runner) {
        return App.execute("list:test:panels", this.layout.panelsRegion, runner);
      };
  ...
  this.App.module("TestPanelsApp.List", function(List, App, Backbone, Marionette, $, _) {
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        var runner;
        runner = options.runner;
        return this.show(new List.Layout);
      };
...
(function() {
  ...
  this.App.module("TestPanelsApp.List", function(List, App, Backbone, Marionette, $, _) {
    return List.Layout = (function(_super) {
      ...
      Layout.prototype.template = "test_panels/list/layout";
...
window.JST["backbone/apps/test_panels/list/templates/layout"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<ul id="ecl-test-panels">\n  <li>.</li>\n  <li>.</li>\n  <li>.</li>\n</ul>');
