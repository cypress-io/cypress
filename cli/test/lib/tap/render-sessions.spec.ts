...
import { renderSessionsHuman } from '../../../lib/tap/render/sessions'
import type { TapSessionSummary } from '../../../lib/tap/commands/sessions'

const render = (sessions: TapSessionSummary[]): string => stripAnsi(renderSessionsHuman(sessions))

describe('lib/tap/render/sessions', () => {
