...
exports['shows help for run --foo 1'] = `
  ...
  Options:
    ...
    --component                                runs component tests
    -c, --config <config>                      sets configuration values. separate multiple values with a comma. overrides any value in cypress.config.{js|ts}.
    -C, --config-file <config-file>            path to script file where configuration values are set. defaults to "cypress.config.{js|ts}".
    --e2e                                      runs end to end tests
    -e, --env <env>                            sets environment variables. separate multiple values with a comma. overrides any value in cypress.config.{js|ts} or cypress.env.json
    ...
    -p, --port <port>                          runs Cypress on a specific port. overrides any value in cypress.config.{js|ts}.
    -P, --project <project-path>               path to the project
