...
- Fixed an issue where the injected Cypress script could be inserted after a toplevel <script> tag. Addressed in [#33121](https://github.com/cypress-io/cypress/pull/33121).
