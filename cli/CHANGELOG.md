...
- Fixed an issue where Chrome, Chromium, and Edge could interrupt a test with a permission prompt asking to access other apps and services on this device, or other devices on your local network. Fixes [#34775](https://github.com/cypress-io/cypress/issues/34775).
