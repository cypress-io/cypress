...
- Fixed an issue where screenshots taken after navigating to a new spec via the sidebar in `cypress open` would carry the wrong `specName` in `after:screenshot` event details. Fixes [#26598](https://github.com/cypress-io/cypress/issues/26598).
