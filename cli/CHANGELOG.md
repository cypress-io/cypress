...
- Chrome's "Change your password" data-breach warning popup no longer appears during a test run when the application under test submits a weak or known-breached password. The popup previously stole focus and could disrupt interactions such as hovering. Addresses [#29384](https://github.com/cypress-io/cypress/discussions/29384).
