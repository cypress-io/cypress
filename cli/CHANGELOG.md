...
- Fixed an issue on macOS and Windows where [`trashAssetsBeforeRuns`](https://docs.cypress.io/app/references/configuration#Global) silently left assets behind when a file or folder name contained square brackets or curly braces. Addressed in [#34590](https://github.com/cypress-io/cypress/pull/34590).
