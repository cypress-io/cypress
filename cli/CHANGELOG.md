...
- Fixed an issue where the console output for a [`cy.env()`](https://on.cypress.io/env) command in the Command Log listed the requested environment variable names under numbered keys instead of a single `Env vars` label. Addressed in [#34615](https://github.com/cypress-io/cypress/pull/34615).
