...
- Fixed a race during Firefox launch where geckodriver returned before the WebDriver BiDi WebSocket was ready, causing the first BiDi command to fail. Fixed in [#33770](https://github.com/cypress-io/cypress/pull/33770).
