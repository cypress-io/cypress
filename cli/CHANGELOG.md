...
- The [Debug page](https://docs.cypress.io/guides/cloud/runs#Debug) now allows for navigating between all runs recorded for a commit.  Addressed in [#26017](https://github.com/cypress-io/cypress/pull/26017).
