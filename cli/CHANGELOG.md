...
- Fixed an issue where screenshots taken after navigating to a new spec via the sidebar in `cypress open` would carry the wrong `specName` in `after:screenshot` event details. Fixed in [#34056](https://github.com/cypress-io/cypress/pull/34056).
