...
- Fixed an issue where a transient Firefox launch failure (`No connection to WebDriver Bidi was established`) caused Cypress to exit with code 1 before any spec executed instead of retrying the browser launch. Fixed in [#33770](https://github.com/cypress-io/cypress/pull/33770).
