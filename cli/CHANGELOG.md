...
- Fixed an issue where Cypress would not run if Nodejs version `22.7.0` was being used with Typescript and ES Modules. Fixes [#30084](https://github.com/cypress-io/cypress/issues/30084).
