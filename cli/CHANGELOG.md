...
- Expanded `cy.press()` to support more key types. Addresses [#31049](https://github.com/cypress-io/cypress/issues/31049). Addressed in [#31496](https://github.com/cypress-io/cypress/pull/31496).
