...
- Selectors accepted in the `selectorPriority` of the `SelectorPlayground` (renamed to `ElementSelector`) API have been expanded to accept `name` and `attributes:*`. Addresses [#31801](https://github.com/cypress-io/cypress/issues/30309). Addressed in [#31889](https://github.com/cypress-io/cypress/pull/31889).
