...
- [`cy.press()`](https://on.cypress.io/press) is now supported in the experimental WebKit browser. Previously, calling it in WebKit threw an error stating that the browser was unsupported. Addresses [#31054](https://github.com/cypress-io/cypress/issues/31054).
