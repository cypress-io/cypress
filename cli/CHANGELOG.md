...
- Fixed an issue where "isVisible" is incorrectly assessed for the absolutely positioned elements if the ancestor has overflow and static position [#28638](https://github.com/cypress-io/cypress/pull/29689).
