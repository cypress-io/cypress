...
- Upgraded `js-cookie` from `3.0.5` to `3.0.8` to address [CVE-2026-46625](https://github.com/advisories/GHSA-qjx8-664m-686j) (prototype pollution enabling cookie attribute injection) reported in security scans.
