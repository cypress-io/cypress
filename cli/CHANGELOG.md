...
- Fixed an issue in experimental WebKit where extra tabs or popups opened during a spec were left open and could leak into the next spec. Such tabs are now closed between specs, matching the behavior in Chrome.
