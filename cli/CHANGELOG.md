...
- Fixed an issue on macOS where Cypress could detect a browser that it was unable to launch. Cypress now confirms an application's bundle identifier and executable before attempting to open it, and looks elsewhere on disk when the standard location does not match. Addressed in [#TODO](https://github.com/cypress-io/cypress/pull/TODO).
