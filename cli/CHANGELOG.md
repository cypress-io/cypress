...
- Upgraded `mime` from `2.6.0` to `4.0.6`. Addresses [#30144](https://github.com/cypress-io/cypress/issues/30144). Addressed in [#30966](https://github.com/cypress-io/cypress/pull/30966).
