...
- Fixed an issue where `Next.js` Component Testing would not load correctly without a TypeScript-based Next config in versions 16.0.3 and up. Addressed [#32968](https://github.com/cypress-io/cypress/issues/32968).
