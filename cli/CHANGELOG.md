...
- Fixed an issue where absolute file paths were not correctly determined from the source map when the source map root was updated. Addressed in [#32820](https://github.com/cypress-io/cypress/pull/32820).
