...
- Fixed an issue where identical network requests were sometimes shown as separate entries in the Command Log instead of being grouped together, depending on response timing. Matching requests are now grouped consistently. Fixes [#28903](https://github.com/cypress-io/cypress/issues/28903).
