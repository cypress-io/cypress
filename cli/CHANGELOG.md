...
- Fixed an issue where a visit that never fired the page `load` event could leave subsequent commands blocked on the stability queue after `pageLoadTimeout`, instead of failing with the page load timeout error. Addressed in [#33934](https://github.com/cypress-io/cypress/pull/33934).
