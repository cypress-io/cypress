...
- Correctly sync `Cypress.currentRetry` with secondary origin so test reties that leverage `cy.origin()` render logs as expected. Fixes [#28574](https://github.com/cypress-io/cypress/issues/28574).
