...
- Reduced excess memory and CPU usage during experimental WebKit runs against applications that serve responses from a service worker, which over a long run could contribute to the run slowing down or hanging. Addresses [#24896](https://github.com/cypress-io/cypress/issues/24896).
