...
- Fixed an issue where opening an unconfigured project from a git repository sub-directory (such as a monorepo package) skipped project setup: `cypress open --component` asked you to pick an already-installed framework, and `cypress open --e2e` hung on "Initializing config…". Fixes [#27410](https://github.com/cypress-io/cypress/issues/27410) and [#29544](https://github.com/cypress-io/cypress/issues/29544).
