...
- Fixed an issue where visiting an `http://` site would result in an infinite reload/redirect loop in recent versions of Chrome. Fixes [#25891](https://github.com/cypress-io/cypress/issues/25891).
