...
- Improved CI environment detection and CI/commit metadata capture for Cypress Cloud recorded runs. Added support for Harness CI, AWS Amplify Console, Buddy, and Bitrise and removed support for EOL providers. Addressed in [#33396](https://github.com/cypress-io/cypress/pull/33396).
