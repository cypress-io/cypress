...
- Fixed an issue where the Cypress app data directory could grow without bound over time as stale test bundles from previous runs were never cleaned up. Fixes [#20435](https://github.com/cypress-io/cypress/issues/20435). Fixed in [#34116](https://github.com/cypress-io/cypress/pull/34116).
