...
- The [`cy.press()`](http://on.cypress.io/api/press) command no longer errors when used in specs subsequent to the first spec in run mode. Fixes [#31481](https://github.com/cypress-io/cypress/pull/31481).
