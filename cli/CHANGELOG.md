...
- Fixed an issue where Cypress could crash when processes certain requests through our proxy. Fixed in [#28952](https://github.com/cypress-io/cypress/pull/28952).
