...
```
    ...
    when<TR1, UR1, VR1,
        TJ1 = any, UJ1 = any, VJ1 = any>(
            deferredT: JQuery3.Promise<TR1, TJ1> | JQuery3.Thenable<TR1> | TR1,
            deferredU: JQuery3.Promise<UR1, UJ1> | JQuery3.Thenable<UR1> | UR1,
            deferredV: JQuery3.Promise<VR1, VJ1> | JQuery3.Thenable<VR1> | VR1,
    ): JQuery3.Promise3<
        TR1, TJ1, never,
        UR1, UJ1, never,
        VR1, VJ1, never>;
...
```
    ...
    when<TR1, TJ1,
        TR2, TJ2,
        TR3 = never, TJ3 = never>(
            deferredT: JQuery3.Promise3<TR1, TJ1, any, TR2, TJ2, any, TR3, TJ3, any> |
                       JQuery3.Promise2<TR1, TJ1, any, TR2, TJ2, any>
    ): JQuery3.Promise3<
        TR1, TJ1, never,
        TR2, TJ2, never,
        TR3, TJ3, never>;
