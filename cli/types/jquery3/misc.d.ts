...
```
    ...
    // NOTE: This is a private copy of the global Promise interface. It is used by JQuery3.PromiseBase to indicate compatibility with other Promise implementations.
...
```
     ...
     * @since 1.8
     */
    // This should be a class but doesn't work correctly under the JQuery3 namespace. Tween should be an inner class of jQuery.
...
```
    ...
    // This should be a class but doesn't work correctly under the JQuery3 namespace. Event should be an inner class of jQuery.
