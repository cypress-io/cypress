...
declare namespace Cypress {
   ...
   */
     ...
     *    })
     */
    switchToDomain<T>(domain: string, data: T[], fn: (data: T[]) => void): Chainable<any>
    /**
     * Enables running Cypress commands in a secondary domain
     * @see https://on.cypress.io/switchToDomain
     * @example
     ...
     *    })
     */
    switchToDomain(domain: string, done: Mocha.Done, fn: () => void): Chainable<any>
    /**
     * Enables running Cypress commands in a secondary domain
     * @see https://on.cypress.io/switchToDomain
     * @example
     *    cy.switchToDomain('example.com', done, [{ key: 'value' }, 'foo'], ([{ key }, foo]) => {
     *      expect(key).to.equal('value')
     *      expect(foo).to.equal('foo')
     *      done()
     *    })
     */
    switchToDomain<T>(domain: string, done: Mocha.Done, data: T[], fn: (data: T[]) => void): Chainable<any>
