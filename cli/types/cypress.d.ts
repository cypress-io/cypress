...
declare namespace Cypress {
  ...
  interface ResolvedConfigOptions<ComponentDevServerOpts = any> {
    ...
    video: boolean
    /**
     * Whether Chrome Web Security for same-origin policy and insecure mixed content is enabled. Read more about this [here](https://docs.cypress.io/guides/guides/web-security#Disabling-Web-Security)
     * @default true
     */
