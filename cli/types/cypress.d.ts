...
declare namespace Cypress {
  ...
  type ThirdPartyComponentFrameworkDefinition = Omit<Cypress.ComponentFrameworkDefinition, 'glob' | 'codeGenFramework' | 'supportStatus' | 'specPattern' | 'mountModule' | 'configFramework'> 
