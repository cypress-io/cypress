...
| **Timeout** | the alias will retry the chain of commands before the alias assignment for the duration of the [`commandTimeout`](https://on.cypress.io/guides/configuration#section-timeouts) |
