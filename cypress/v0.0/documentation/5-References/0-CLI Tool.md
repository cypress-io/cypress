...
- :fa-angle-right: [What is the CLI Tool?](#what-is-the-cli-tool-)
- :fa-angle-right: [Installation](#installation)
- :fa-angle-right: [Available Commands](#available-commands)
  - [cypress install](#-cypress-install-)
  - [cypress update](#-cypress-update-)
  - [cypress run](#-cypress-run-)
  - [cypress run --record](cli#-cypress-run-record-)
  - [cypress open](#-cypress-open-)
  - [cypress get:path](#-cypress-get-path-)
