...
This repo compares [Cypress Tests](https://github.com/cypress-io/examples-react-travis-ci/blob/master/cypress/integration/app_spec.js) to [official TodoMVC Tests](https://github.com/tastejs/todomvc/blob/master/tests/test.js). This gives you a good comparison of writing and running tests in Cypress versus vanilla Selenium.
...
This is a single page application with a decent amount of features. The [tests](https://github.com/cypress-io/examples-angular-circle-ci/blob/master/cypress/integration/app_spec.js) involve a lot of form submissions.
