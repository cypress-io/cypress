...
Note: When using the `CYPRESS_LOCAL_STUDIO_PATH` environment variable, we bypass our error reporting and instead decide to throw an exception immediately. The purpose of this is to try and weed out any issues by drawing attention to them immediately
