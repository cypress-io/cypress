...
export const monorepoPaths = {
  ...
  pkgBrowserAutomation: path.join(__dirname, '../../packages/browser-automation'),
  ...
  pkgInjection: path.join(__dirname, '../../packages/injection'),
  ...
  pkgNetworkInterception: path.join(__dirname, '../../packages/network-interception'),
