...
run_driver_suite() {
  ...
  local specs="cypress/e2e/e2e/encoding.cy.*,cypress/e2e/e2e/csp_headers.cy.*,cypress/e2e/cypress/proxy-logging.cy.*,cypress/e2e/cy/snapshot.cy.*,cypress/e2e/cypress/downloads.cy.*"
