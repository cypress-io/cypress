window.$Cypress = do ($, _, Backbone, Promise) ->
  ...
  class $Cypress
    ...
    @create = (options = {}) ->
      ...
      for klass in "Cy Log Utils Chai Mocha Runner Agents Server Chainer Location LocalStorage Cookies Keyboard Mouse Command Commands EnvironmentVariables JQuery".split(" ")
