...
import { SuiteModel } from '../../../src/runnables/suite-model'
...
const createSuite = (id: string, tests: Array<TestProps>, suites: Array<SuiteModel>) => {
  return { id, title: `suite ${id}`, tests, suites, hooks: [] } as SuiteModel
}
