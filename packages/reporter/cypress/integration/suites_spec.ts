...
describe('suites', () => {
  ...
  it('includes the class "suite"', () => {
    cy.contains('suite 1').closest('.runnable').should('have.class', 'suite')
  ...
  describe('expand and collapse', () => {
    ...
    describe('expand/collapse suite manually', () => {
      ...
      it('expands/collapses on click', () => {
        ...
        cy.get('@suiteWrapper').should('have.class', 'is-open').find('.collapsible-content').eq(0).should('be.visible')
      })
  ...
  describe('studio button', () => {
    ...
    it('emits studio:init:suite with the suite id when clicked', () => {
      ...
      cy.contains('suite 1').parents('.collapsible-header').find('.runnable-controls-studio').click()
