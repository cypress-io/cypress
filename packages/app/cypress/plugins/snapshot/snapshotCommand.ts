...
import { printVar, stringifyShort, isObject, addPluginButton, fmt, typeColors } from './snapshotUtils'
import $ from 'jquery'
...
export const registerInCypress = () => {
...
export const matchDeep = function (matchers, exp, optsArg) {
  let m = matchers
...
export const parseMatcherFromString = (matcher) => {
  const regex = /match\.(.*)/
