export const snapshots = {
  ...
  'src/cypress/runner retries mochaEvents cant retry from [after] #1': [
    [
      'mocha',
      'start',
      {
  ...
  'src/cypress/runner retries mochaEvents screenshots retry screenshot in test body #1': [
    'take:screenshot',
    {
      'titles': [
        'suite 1',
  ...
  'src/cypress/runner retries mochaEvents screenshots retry screenshot in test body #2': {
    'id': 'r3',
    'testAttemptIndex': 'match.match(0)',
    'isOpen': false,
    'appOnly': true,
