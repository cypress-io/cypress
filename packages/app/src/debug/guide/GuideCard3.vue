<template>
  <PromoCard
    ...
    :body="t('debugPage.emptyStates.slideshow.step3.description')"
  >
    <template #image>
      <Illustration />
    </template>
    <template #action>
      <PromoAction
        ...
        :right-label="t('debugPage.emptyStates.slideshow.controls.reset')"
      />
    </template>
  </PromoCard>
</template>
...
import Illustration from '../../assets/debug-guide-skeleton-3.svg'
