...
const driverToSocketEvents = 'backend:request automation:request mocha recorder:frame dev-server:start dev-server:stop dev-server:on-spec-update'.split(' ')
...
const socketToDriverEvents = 'net:stubbing:event request:event script:error cross:origin:cookies dev-server:started dev-server:stopped dev-server:on-spec-updated'.split(' ')
