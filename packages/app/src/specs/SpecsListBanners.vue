...
import { SpecsListBanners_CheckCloudOrgMembershipDocument } from '../generated/graphql'
...
import type { CohortConfig, CohortOption } from '@packages/frontend-shared/src/gql-components/composables/useCohorts'
