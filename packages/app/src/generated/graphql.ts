...
export type AppQueryQuery = (
  { readonly __typename?: 'Query', readonly app: { readonly __typename?: 'App', readonly activeProject: Maybe<{ readonly __typename?: 'LocalProject', readonly title: string }> } }
  & WizardFragment
);

export type HeaderBarFragment = { readonly __typename?: 'App', readonly activeProject: Maybe<{ readonly __typename?: 'LocalProject', readonly title: string }> };
...
export type OpenBrowserAppFragment = { readonly __typename?: 'App', readonly browsers: ReadonlyArray<{ readonly __typename?: 'Browser', readonly displayName: string, readonly version: string, readonly majorVersion: Maybe<string>, readonly name: string }> };

export type OpenBrowserWizardFragment = { readonly __typename?: 'Wizard', readonly testingType: Maybe<TestingTypeEnum> };
...
export type TestingTypeFragment = { readonly __typename?: 'Wizard', readonly testingTypes: ReadonlyArray<{ readonly __typename?: 'TestingTypeInfo', readonly id: TestingTypeEnum, readonly title: string, readonly description: string }> };

export type TestingTypeCardsFragment = { readonly __typename?: 'Query', readonly app: { readonly __typename?: 'App', readonly activeProject: Maybe<{ readonly __typename?: 'LocalProject', readonly hasSetupComponentTesting: boolean, readonly hasSetupE2ETesting: boolean }> }, readonly wizard: { readonly __typename?: 'Wizard', readonly testingTypes: ReadonlyArray<{ readonly __typename?: 'TestingTypeInfo', readonly id: TestingTypeEnum, readonly title: string, readonly description: string }> } };

export type TestingTypeCardsNavigateForwardMutationVariables = Exact<{ [key: string]: never; }>;


export type TestingTypeCardsNavigateForwardMutation = { readonly __typename?: 'Mutation', readonly wizardNavigate: Maybe<{ readonly __typename?: 'Wizard', readonly step: WizardStep }> };

export type WizardFragment = (
  { readonly __typename?: 'Query', readonly app: (
    { readonly __typename?: 'App', readonly isFirstOpen: boolean, readonly activeProject: Maybe<{ readonly __typename?: 'LocalProject', readonly hasSetupComponentTesting: boolean, readonly hasSetupE2ETesting: boolean }> }
    & ProjectRootFragment
    & OpenBrowserAppFragment
  ), readonly wizard: (
...
export const OpenBrowserAppFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OpenBrowserApp"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"App"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"browsers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"majorVersion"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<OpenBrowserAppFragment, unknown>;
...
export const OpenBrowserWizardFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OpenBrowserWizard"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Wizard"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"testingType"}}]}}]} as unknown as DocumentNode<OpenBrowserWizardFragment, unknown>;
export const WizardFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Wizard"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Query"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"TestingTypeCards"}},{"kind":"Field","name":{"kind":"Name","value":"app"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isFirstOpen"}},{"kind":"Field","name":{"kind":"Name","value":"activeProject"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasSetupComponentTesting"}},{"kind":"Field","name":{"kind":"Name","value":"hasSetupE2ETesting"}}]}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectRoot"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"OpenBrowserApp"}}]}},{"kind":"Field","name":{"kind":"Name","value":"wizard"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"step"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"testingType"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"TestingType"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ConfigFile"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"InstallDependencies"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"EnvironmentSetup"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"OpenBrowserWizard"}}]}}]}},...TestingTypeCardsFragmentDoc.definitions,...ProjectRootFragmentDoc.definitions,...OpenBrowserAppFragmentDoc.definitions,...TestingTypeFragmentDoc.definitions,...ConfigFileFragmentDoc.definitions,...InstallDependenciesFragmentDoc.definitions,...EnvironmentSetupFragmentDoc.definitions,...OpenBrowserWizardFragmentDoc.definitions]} as unknown as DocumentNode<WizardFragment, unknown>;
...
export const AppQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AppQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Wizard"}},{"kind":"Field","name":{"kind":"Name","value":"app"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"activeProject"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}},...WizardFragmentDoc.definitions]} as unknown as DocumentNode<AppQueryQuery, AppQueryQueryVariables>;
...
export const TestingTypeCardsNavigateForwardDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"TestingTypeCardsNavigateForward"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"wizardNavigate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"direction"},"value":{"kind":"EnumValue","value":"forward"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"step"}}]}}]}}]} as unknown as DocumentNode<TestingTypeCardsNavigateForwardMutation, TestingTypeCardsNavigateForwardMutationVariables>;
