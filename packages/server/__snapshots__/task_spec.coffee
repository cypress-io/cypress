...
> Error: Error thrown in task handler
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/task_spec-coffee -- throws when task returns undefined -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/task_spec-coffee -- includes stack trace in error -- failure.png (1280x720)
