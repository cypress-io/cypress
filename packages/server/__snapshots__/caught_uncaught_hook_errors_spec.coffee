...
Because this error occurred during a 'before all' hook we are skipping the remaining tests in the current suite: 's4a'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/s1a -- t2a -- before each hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/s3a -- t8a -- before all hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/s4a -- t10a -- before all hook -- failure.png (1280x720)
...
Because this error occurred during a 'before each' hook we are skipping the remaining tests in the current suite: 's1b'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/s1b -- t2b -- before each hook -- failure.png (1280x720)
...
Because this error occurred during a 'before each' hook we are skipping all of the remaining tests.
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/t1c -- before each hook -- failure.png (1280x720)
...
Because this error occurred during a 'before each' hook we are skipping the remaining tests in the current suite: 's1'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/uncaught hook error should continue to fire all mocha events -- s1 -- does not run -- before each hook -- failure.png (1280x720)
