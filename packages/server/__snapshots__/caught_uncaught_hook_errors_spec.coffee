...
Because this error occurred during a 'before all' hook we are skipping the remaining tests in the current suite: 's4a'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/hook_caught_error_failing_spec-coffee -- s1a -- t2a -- before each hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/hook_caught_error_failing_spec-coffee -- s3a -- t8a -- before all hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/hook_caught_error_failing_spec-coffee -- s4a -- t10a -- before all hook -- failure.png (1280x720)
...
Because this error occurred during a 'before each' hook we are skipping the remaining tests in the current suite: 's1b'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/hook_uncaught_error_failing_spec-coffee -- s1b -- t2b -- before each hook -- failure.png (1280x720)
...
Because this error occurred during a 'before each' hook we are skipping all of the remaining tests.
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/hook_uncaught_root_error_failing_spec-coffee -- t1c -- before each hook -- failure.png (1280x720)
...
Because this error occurred during a 'before each' hook we are skipping the remaining tests in the current suite: 's1'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/hook_uncaught_error_events_failing_spec-coffee -- uncaught hook error should continue to fire all mocha events -- s1 -- does not run -- before each hook -- failure.png (1280x720)
