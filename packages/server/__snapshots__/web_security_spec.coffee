...
https://on.cypress.io/cross-origin-violation
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/web_security_spec-coffee -- web security -- fails when clicking a to another origin -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/web_security_spec-coffee -- web security -- fails when submitted a form and being redirected to another origin -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/web_security_spec-coffee -- web security -- fails when using a javascript redirect to another origin -- failure.png (1280x720)
