...
Because this error occurred during a 'after each' hook we are skipping the remaining tests in the current suite: 'issue 674'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/issue_674_spec.coffee/issue 674 -- doesn't hang when both beforeEach and afterEach fail -- before each hook (failed).png (YYYYxZZZZ)
  - /foo/bar/.projects/e2e/cypress/screenshots/issue_674_spec.coffee/issue 674 -- doesn't hang when both beforeEach and afterEach fail -- after each hook (failed).png (YYYYxZZZZ)
