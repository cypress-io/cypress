...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  1) fails because the 'task' event is not registered in background file
...
The 'task' event has not been registered in the background file. You must register it before using cy.task()

Fix this in your background file here:
/foo/bar/.projects/task-not-registered/cypress/background/index.js
...
https://on.cypress.io/api/task
  ...
  - /foo/bar/.projects/task-not-registered/cypress/screenshots/task_not_registered_spec.coffee/fails because the 'task' event is not registered in background file (failed).png (1280x720)
