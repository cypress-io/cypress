...
Because this error occurred during a 'after each' hook we are skipping the remaining tests in the current suite: 'issue 674'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/issue 674 -- doesnt hang when both beforeEach and afterEach fail -- before each hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/issue 674 -- doesnt hang when both beforeEach and afterEach fail -- after each hook -- failure.png (1280x720)
