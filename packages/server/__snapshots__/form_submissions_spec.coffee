exports['e2e form submissions passing 1'] = `Error: connect ECONNREFUSED 127.0.0.1:1234
...
exports['e2e form submissions failing 1'] = `Error: connect ECONNREFUSED 127.0.0.1:1234
 > The local API server isn't running in development. This may cause problems running the GUI.
