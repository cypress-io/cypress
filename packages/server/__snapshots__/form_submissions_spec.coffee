...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/form_submission_failing_spec-coffee -- form submission fails -- fails without an explicit wait when an element is immediately found -- failure.png (1280x720)
