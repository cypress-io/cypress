...
exports['lib/util/spec_writer #createNewTestInFile can create a new test in a suite defined with describe 1'] = `
describe('top level suite', () => {
  describe('inner suite with describe', () => {
    it('test with it', () => {
      cy.get('.btn').click()
...
exports['lib/util/spec_writer #createNewTestInFile can create a new test in a suite defined with context 1'] = `
describe('top level suite', () => {
  describe('inner suite with describe', () => {
    it('test with it', () => {
      cy.get('.btn').click()
...
exports['lib/util/spec_writer #createNewTestInFile can create a new test in a suite defined with describe only 1'] = `
describe('top level suite', () => {
  describe('inner suite with describe', () => {
    it('test with it', () => {
      cy.get('.btn').click()
