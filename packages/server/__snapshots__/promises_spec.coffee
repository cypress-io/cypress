...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/promises_spec-coffee -- catches regular promise errors -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/promises_spec-coffee -- catches promise errors and calls done with err even when async -- failure.png (1280x720)
