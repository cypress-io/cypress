...
Because this error occurred during a 'after each' hook we are skipping the remaining tests in the current suite: 'each hooks'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/taking screenshots -- generates pngs on failure -- failure.png (1280x720)
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/taking screenshots -- ensures unique paths when theres a non-named screenshot and a failure -- failure.png (1280x720)
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/taking screenshots -- before hooks -- empty test 1 -- before all hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/taking screenshots -- each hooks -- empty test 2 -- before each hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/taking screenshots -- each hooks -- empty test 2 -- after each hook -- failure.png (1280x720)
