...
Because this error occurred during a 'after each' hook we are skipping the remaining tests in the current suite: 'each hooks'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/black.png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/red.png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/foo/bar/baz.png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- generates pngs on failure (failed).png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/color-check.png (1050x932)
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/pathological.png (1050x720)
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- ensures unique paths for non-named screenshots.png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- ensures unique paths for non-named screenshots (1).png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- ensures unique paths for non-named screenshots (2).png (1050x932)
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- ensures unique paths when there's a non-named screenshot and a failure (failed).png (1050x932)
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- before hooks -- empty test 1 -- before all hook (failed).png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- each hooks -- empty test 2 -- before each hook (failed).png (1050x932)
  - /foo/bar/.projects/e2e/cypress/screenshots/screenshots_spec.js/taking screenshots -- each hooks -- empty test 2 -- after each hook (failed).png (1050x932)
