...
https://on.cypress.io/api/task
  ...
  - /foo/bar/.projects/task-not-registered/cypress/screenshots/task_not_registered_spec-coffee -- fails because the task event is not registered in plugins file -- failure.png (1280x720)
