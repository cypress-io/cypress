...
Because this error occurred during a 'before each' hook we are skipping the remaining tests in the current suite: 'record fails'
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/record_fail_spec-coffee -- record fails -- fails 1 -- before each hook -- failure.png (1280x720)
  ...
  - Done Uploading (1/2) /foo/bar/.projects/e2e/cypress/screenshots/record_fail_spec-coffee -- record fails -- fails 1 -- before each hook -- failure.png
...
We dynamically generated a new test to display this failure.
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/record_uncaught_spec-coffee -- An uncaught error was detected outside of a test -- failure.png (1280x720)
  ...
  - Done Uploading (1/2) /foo/bar/.projects/e2e/cypress/screenshots/record_uncaught_spec-coffee -- An uncaught error was detected outside of a test -- failure.png
  - Done Uploading (2/2) /foo/bar/.projects/e2e/cypress/videos/abc123.mp4
