...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/async_timeouts_spec.coffee/async -- bar fails (failed).png (YYYYxZZZZ)
  - /foo/bar/.projects/e2e/cypress/screenshots/async_timeouts_spec.coffee/async -- fails async after cypress command (failed).png (YYYYxZZZZ)
