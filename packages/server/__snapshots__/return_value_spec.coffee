...
https://on.cypress.io/returning-value-and-commands-in-custom-command
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/errors when invoking commands and return a different value -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/errors when invoking commands in custom command and returning differnet value -- failure.png (1280x720)
