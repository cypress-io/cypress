...
[mochawesome] Report saved to mochawesome-reports/mochawesome.html
  ...
  - /foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec-coffee -- simple failing hook spec -- beforeEach hooks -- never gets here -- before each hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec-coffee -- simple failing hook spec -- afterEach hooks -- runs this -- after each hook -- failure.png (1280x720)
  - /foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec-coffee -- simple failing hook spec -- after hooks -- fails on this -- after all hook -- failure.png (1280x720)
