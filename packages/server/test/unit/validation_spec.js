...
describe("lib/util/validation", function() {
  context("#isValidBrowserList", () => it("does not allow empty or not browsers", function() {
  ...
  context("#isValidBrowser", () => it("passes valid browsers and forms error messages for invalid ones", function() {
    const browsers = [
      // valid browser
      {
        name: "Chrome",
  ...
  return context("#isOneOf", function() {
    ...
    return it("validates a number", function() {
