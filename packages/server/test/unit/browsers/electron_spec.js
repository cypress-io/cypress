...
describe('lib/browsers/electron', () => {
  ...
  context('.open', () => {
    ...
    it('calls render with url, state, and options', function () {
      return electron.open('electron', this.url, this.options, this.automation).then(() => {
        ...
        expect(electron._render).to.be.calledWith(this.url, this.automation)
      })
    })
  ...
  context('._render', () => {
    ...
    it('creates window instance and calls launch with window', function () {
      return electron._render(this.url, this.automation, this.preferences, this.options).then(() => {
    ...
    it('calls setSize on electron window if headless', function () {
      ...
      return electron._render(this.url, this.automation, preferences, this.options).then(() => {
