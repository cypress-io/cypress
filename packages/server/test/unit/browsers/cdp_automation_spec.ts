  ...
  context('.CdpAutomation', () => {
    ...
    describe('get:cookie', () => {
      ...
      it('returns a specific cookie by name', function () {
        return this.onRequest('get:cookie', { domain: 'google.com', name: 'session' }).then((resp) => {
          expect(resp).to.deep.eq({
            name: 'session',
            value: 'key',
            path: '/login',
      ...
      it('returns null when no cookie by name is found', function () {
        return this.onRequest('get:cookie', { domain: 'google.com', name: 'doesNotExist' }).then((resp) => {
    ...
    describe('set:cookie', () => {
      ...
      it('resolves with the cookie props', function () {
        return this.onRequest('set:cookie', { domain: 'google.com', name: 'session', value: 'key', path: '/' }).then(
          (resp) => {
            expect(resp).to.deep.eq({
              domain: '.google.com',
    ...
    describe('clear:cookie', () => {
      ...
      it('resolves single removed cookie', function () {
        return this.onRequest('clear:cookie', { domain: 'google.com', name: 'session' }).then((resp) => {
          expect(resp).to.deep.eq({
            name: 'session',
            value: 'key',
            path: '/',
      ...
      it('returns null when no cookie by name is found', function () {
        return this.onRequest('clear:cookie', { domain: 'google.com', name: 'doesNotExist' }).then((resp) => {
          expect(resp).to.be.null
        })
      })
