  ...
  context('integration', () => {
    ...
    context('on(automation:request)', () => {
      describe('#onAutomation', () => {
        ...
        it('does not return cypress namespace or socket io cookies', function (done) {
          ...
          .yieldsAsync([
            ...
            { name: '__cypress.socketIo', value: 'b', path: '/', domain: 'localhost', secure: false, httpOnly: false, expirationDate: 456, c: 'a', d: 'c' },
          ])
        ...
        it('does not clear any namespaced cookies', function (done) {
          ...
          const cookies = [
            ...
            { domain: 'localhost', name: '__cypress.socketIo', value: '123abc' },
          ]
      ...
      describe('options.onAutomationRequest', () => {
        ...
        it('does not return __cypress or __cypress.socketIo namespaced cookies', () => {})
