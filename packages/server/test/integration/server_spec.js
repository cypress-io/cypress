...
const expectToEqDetails = function(actual, expected) {
  ...
  return expect(actual).to.deep.eq(expected);
};

describe("Server", function() {
  require("mocha-banner").register();

  beforeEach(() => sinon.stub(Server.prototype, "reset"));

  return context("resolving url", function() {
    beforeEach(function() {
        ...
        .then(cfg => {
          ...
          return Promise.all([
            ...
            .spread(port => {
              ...
              return this.fileServer = this.server._fileServer.address();
            })
          ]);
        });
      };
    ...
    describe("file", function() {
      ...
      it("can serve static assets", function() {
        ...
        .then((obj = {}) => expectToEqDetails(obj, {
          isOkStatusCode: true,
          isHtml: true,
          ...
          .then(function(res) {
            ...
            return expect(res.body).to.include("Cypress.action('app:window:before:load', window); </script>\n  </head>");
          });
        });
      });
      ...
      it("buffers the response", function() {
        ...
        .then((obj = {}) => {
          ...
          return expect(this.buffers.buffer).to.include({ url: "http://localhost:2000/index.html" });
      }).then(() => {
          return this.server._onResolveUrl("/index.html", {}, this.automationRequest)
          .then((obj = {}) => {
            expectToEqDetails(obj, {
            ...
            return expect(this.server._request.sendStream).to.be.calledTwice;
          });
        }).then(() => {
          return this.rp("http://localhost:2000/index.html")
          .then(res => {
            ...
            return expect(this.buffers.buffer).to.be.undefined;
          });
        });
      });
      ...
      it("can follow static file redirects", function() {
        ...
        .then((obj = {}) => expectToEqDetails(obj, {
          ...
          .then(res => {
            ...
            return expect(this.server._getRemoteState()).to.deep.eq({
              auth: undefined,
      ...
      it("gracefully handles 404", function() {
        ...
        .then((obj = {}) => expectToEqDetails(obj, {
          ...
          .then(function(res) {
            ...
            return expect(res.body).to.include("The file was not found");
          });
        });
      });

      return it("handles urls with hashes", function() {
    ...
    describe("http", function() {
      ...
      context("only having one request in flight at a time", function() {
        beforeEach(function(done) {
          ...
          return this.runOneReqTest = path => {
            ...
            .then(() => {
              ...
              return expect(p1.reqStream.aborted).to.be.true;
            });
          };
        });
        ...
        return it("cancels and aborts the 1st request when it hasn't loaded body and a 2nd request is made", function() {
      ...
      it("can serve http requests", function() {
        ...
        .then((obj = {}) => expectToEqDetails(obj, {
          ...
          .then(function(res) {
            ...
            return expect(res.body).to.include("Cypress.action('app:window:before:load', window); </script> </head>content</html>");
          });
        });
      });
      ...
      it("buffers the http response", function() {
        ...
        .then((obj = {}) => {
          ...
          return expect(this.buffers.buffer).to.include({ url: "http://espn.go.com/" });
      }).then(() => {
          return this.server._onResolveUrl("http://espn.com/", {}, this.automationRequest)
          .then((obj = {}) => {
            expectToEqDetails(obj, {
      ...
      it("gracefully handles http errors", function() {
        ...
        .catch(function(err) {
          ...
          return expect(err.code).to.eq("ECONNREFUSED");
        });
      });
      ...
      it("handles url hashes", function() {
        ...
        .then((obj = {}) => {
          ...
          return expect(this.buffers.buffer).to.include({ url: "http://getbootstrap.com/" });
      }).then(() => {
          return this.rp("http://getbootstrap.com/")
          .then(res => {
            expect(res.statusCode).to.eq(200);
      ...
      return it("passes auth through", function() {
        const username = "u";
        const password = "p";
    ...
    return describe("both", function() {
      ...
      it("can go from http -> file -> http", function() {
        ...
        .then((obj = {}) => expectToEqDetails(obj, {
          ...
          .then(function(res) {
            ...
            return expect(res.body).to.include("Cypress.action('app:window:before:load', window); </script></head><body>google</body></html>");
          });
        }).then(() => {
          return expect(this.server._getRemoteState()).to.deep.eq({
            auth: undefined,
      ...
      it("can go from https -> file -> https", function() {
        ...
        .then((obj = {}) => expectToEqDetails(obj, {
          ...
          .then(function(res) {
            ...
            return expect(res.body).to.include("Cypress.action('app:window:before:load', window); </script></head><body>https server</body></html>");
          });
        }).then(() => {
          return expect(this.server._getRemoteState()).to.deep.eq({
            auth: undefined,
      ...
      return it("can go from https -> file -> https without a port", function() {
        this.timeout(5000);
        ...
        .then((obj = {}) => expectToEqDetails(obj, {
          ...
          .then(function(res) {
            ...
            return expect(res.body).to.include("Cypress");
          });
        }).then(() => {
          return expect(this.server._getRemoteState()).to.deep.eq({
            auth: undefined,
