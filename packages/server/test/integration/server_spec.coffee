      ...
      it "can serve static assets", ->
        ...
        .then =>
          ...
          .then (res) ->
            ...
            expect(res.body).to.include("Cypress.action('app:page:start', window); </script>\n  </head>")
      ...
      it "can serve http requests", ->
        ...
        .then =>
          ...
          .then (res) ->
            ...
            expect(res.body).to.include("Cypress.action('app:page:start', window); </script> </head>content</html>")
      ...
      it "buffers the http response", ->
        ...
        .then =>
          ...
          .then (res) =>
            ...
            expect(res.body).to.include("Cypress.action('app:page:start', window); </script></head><body>espn</body></html>")
            expect(buffers.keys()).to.deep.eq([])
      ...
      it "can go from http -> file -> http", ->
        ...
        .then =>
          ...
          .then (res) ->
            ...
            expect(res.body).to.include("Cypress.action('app:page:start', window); </script></head><body>google</body></html>")
        .then =>
          expect(@server._getRemoteState()).to.deep.eq({
            auth: undefined
            origin: "http://www.google.com"
      ...
      it "can go from https -> file -> https", ->
        ...
        .then =>
          ...
          .then (res) ->
            ...
            expect(res.body).to.include("Cypress.action('app:page:start', window); </script></head><body>https server</body></html>")
        .then =>
          expect(@server._getRemoteState()).to.deep.eq({
            auth: undefined
