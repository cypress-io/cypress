...
const getRequestUrls = () => _.map(requests, "url");
...
const sendUploadUrls = function(req, res) {
  ...
  const screenshotUploadUrls = _.map(body.screenshots, function(s) {
    num += 1;
...
const assertResponseBodySchema = function(req, res, next) {
  ...
  res.end = function(chunk) {
    ...
    chunks.map(chunk => res.write(chunk));
    return res.end();
  };
...
const onServer = routes => (function(app) {
  app.use(bodyParser.json());

  app.use(assertResponseBodySchema);

  return _.each(routes, route => app[route.method](route.url, ensureSchema(
    route.req,
    route.res,
    route.resSchema
  )));
...
const setup = (routes, settings = {}) => e2e.setup({
  settings: _.extend({
    projectId: "pid123",
...
const defaultRoutes = [
  {
    ...
    res(req, res) { return res.sendStatus(200); }
  }, {
    method: "put",
    url: "/videos/:name",
    res(req, res) {
...
describe("e2e record", function() {
  beforeEach(() => requests = []);

  context("passing", function() {
    setup(defaultRoutes);
    ...
    return it("passes", function() {
      ...
      .then(function(stdout) {
        ...
        .then(results => expect(results.runUrl).to.equal(runUrl));
      });
    });
  });

  context("parallelization", function() {
    const allSpecs = [
      "cypress/integration/record_error_spec.coffee",
      "cypress/integration/record_fail_spec.coffee",
      "cypress/integration/record_pass_spec.coffee",
    ...
    const postInstanceResponses = specs => _
    .chain(specs)
    .map((spec, i) => ({
      spec,
      instanceId,
    ...
    routes[1] = {
      ...
      res(req, res) {
        ...
        if ((mId === "a1") && (claimed.length === 0)) {
          return waitUntilSecondInstanceClaims = function() {
    ...
    return it("passes in parallel with group", function() {
      return Promise.all([
        e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record*",
  ...
  context("misconfiguration", function() {
    setup([]);
    ...
    it("errors and exits when no specs found", function() {
      ...
      .then(() => expect(getRequestUrls()).to.be.empty);
    });

    return it("errors and exits when no browser found", function() {
      return e2e.exec(this, {
  ...
  context("projectId", function() {
    ...
    return it("errors and exits without projectId", function() {
      return e2e.exec(this, {
        key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
        spec: "record_pass*",
        record: true,
  ...
  context("recordKey", function() {
    ...
    it("warns but does not exit when is forked pr", function() {
      ...
      .then(function() {
        ...
        return expect(getRequestUrls()).to.be.empty;
      });
    });

    return it("warns but does not exit when is forked pr and parallel", function() {
      process.env.CIRCLECI = "true";
  ...
  context("video recording", function() {
    setup(defaultRoutes, {
      video: false
    });

    return it("does not upload when not enabled", function() {
      return e2e.exec(this, {
        key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
        spec: "record_pass*",
        record: true,
  ...
  context("api interaction errors", function() {
    describe("recordKey and projectId", function() {
      const routes = [
        {
          method: "post",
          url: "/runs",
          req: "postRunRequest@2.2.0",
          res(req, res) { return res.sendStatus(401); }
        }
      ];

      setup(routes);

      return it("errors and exits on 401", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("project 404", function() {
      const routes = [
        {
          method: "post",
          url: "/runs",
          req: "postRunRequest@2.2.0",
          res(req, res) { return res.sendStatus(404); }
        }
      ];

      setup(routes);

      return it("errors and exits", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("create run 500", function() {
      const routes = [{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
        res(req, res) { return res.sendStatus(500); }
      }];
      ...
      return it("does not proceed and exits with error when parallelizing", function() {
        process.env.DISABLE_API_RETRIES = "true";
    ...
    describe("create instance 500", function() {
      const routes = defaultRoutes.slice(0);
      ...
      return it("does not proceed and exits with error when parallelizing and creating instance", function() {
        process.env.DISABLE_API_RETRIES = "true";
    ...
    describe("update instance 500", function() {
      const routes = defaultRoutes.slice(0);
      ...
      return it("does not proceed and exits with error when parallelizing and updating instance", function() {
        process.env.DISABLE_API_RETRIES = "true";
    ...
    describe("create run 422", function() {
      const routes = [{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
        res(req, res) { return res.status(422).json({
      ...
      return it("errors and exits when group name is in use", function() {
    ...
    describe("create run unknown 422", function() {
      const routes = [{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
      ...
      return it("errors and exits when there is an unknown 422 response", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          group: "e2e-tests",
    ...
    describe("create run 402 - free plan exceeds monthly private tests", function() {
      setup([{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
        res(req, res) { return res.status(402).json({
      ...
      return it("errors and exits when on free plan and over recorded runs limit", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("create run 402 - free plan exceeds monthly tests", function() {
      setup([{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
      ...
      return it("errors and exits when on free plan and over recorded tests limit", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("create run 402 - parallel feature not available in plan", function() {
      setup([{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
      ...
      return it("errors and exits when attempting parallel run when not available in plan", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("create run 402 - grouping feature not available in plan", function() {
      setup([{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
    ...
    describe("create run 402 - unknown error", function() {
      setup([{
        method: "post",
        url: "/runs",
        req: "postRunRequest@2.2.0",
      ...
      return it("errors and exits when there's an unknown 402 error", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("create instance", function() {
      ...
      return it("does not update instance", function() {
        process.env.DISABLE_API_RETRIES = "true";
    ...
    describe("update instance", function() {
      ...
      return it("does not update instance stdout", function() {
        process.env.DISABLE_API_RETRIES = "true";
    ...
    describe("update instance stdout", function() {
      const routes = [
        {
          method: "post",
          url: "/runs",
      ...
      return it("warns but proceeds", function() {
        process.env.DISABLE_API_RETRIES = "true";
    ...
    describe("uploading assets", function() {
      const routes = [
        {
          method: "post",
          url: "/runs",
      ...
      return it("warns but proceeds", function() {
        ...
        .then(function() {
          ...
          return expect(urls).to.have.members([
            "POST /runs",
            `POST /runs/${runId}/instances`,
            `PUT /instances/${instanceId}`,
            "PUT /videos/video.mp4",
    ...
    return describe("api retries on error", function() {
      let count = 0;
      ...
      return it("warns and does not create or update instances", function() {
  ...
  return describe("api interaction warnings", () => describe("create run warnings", function() {
    describe("grace period - over private tests limit", function() {
      ...
      routes[0] = {
        ...
        req: "postRunRequest@2.2.0",
        resSchema: "postRunResponse@2.2.0",
        res(req, res) { return res.status(200).json({
          runId,
          groupId,
          machineId,
          runUrl,
      ...
      return it("warns when over private test recordings", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("grace period - over tests limit", function() {
      const routes = defaultRoutes.slice();
      routes[0] = {
        method: "post",
        url: "/runs",
      ...
      return it("warns when over test recordings", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("grace period - parallel feature", function() {
      const routes = defaultRoutes.slice();
      routes[0] = {
        method: "post",
        url: "/runs",
      ...
      return it("warns when using parallel feature", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
    ...
    describe("grace period - grouping feature", function() {
      const routes = defaultRoutes.slice();
      routes[0] = {
        method: "post",
        url: "/runs",
    ...
    describe("paid plan - over private tests limit", function() {
      const routes = defaultRoutes.slice();
      routes[0] = {
        method: "post",
        url: "/runs",
    ...
    describe("paid plan - over tests limit", function() {
      const routes = defaultRoutes.slice();
      routes[0] = {
        method: "post",
        url: "/runs",
    ...
    return describe("unknown warning", function() {
      const routes = defaultRoutes.slice();
      routes[0] = {
        method: "post",
        url: "/runs",
      ...
      return it("warns with unknown warning code", function() {
        return e2e.exec(this, {
          key: "f858a2bc-b469-4e48-be67-0876339ee7e1",
          spec: "record_pass*",
          record: true,
