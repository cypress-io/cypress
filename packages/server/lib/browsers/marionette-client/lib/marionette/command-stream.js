...
(function (module, ns) {
  ...
  let debug = require('debug')('marionette:command-stream')
  let Responder = ns.require('responder')
  let wire = require('json-wire-protocol')
  ...
  let proto = CommandStream.prototype = Object.create(
    Responder.prototype,
  )
