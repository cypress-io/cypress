...
import type { BannersState, FoundBrowser, FoundSpec, OpenProjectLaunchOptions, PromptsShown, ReceivedCypressOptions, ResolvedConfigurationOptions, TestingType, VideoRecording } from '@packages/types'
...
export interface Cfg extends ReceivedCypressOptions {
  ...
  state?: {
    ...
    promptsShown?: PromptsShown | null
