...
const keys: Record<string, string> = {
  development: ``,
  test: ``,
}

keys.staging = keys.development
// TODO: Replace with dedicated prod key
keys.production = keys.development

const keyObjects: Record<string, crypto.KeyObject> = {}

function getPublicKey () {
  const key = process.env.CYPRESS_INTERNAL_ENV || 'production'

  if (!keyObjects[key]) {
    keyObjects[key] = crypto.createPublicKey(Buffer.from(keys[key], 'base64').toString('utf8').trim())
  }
