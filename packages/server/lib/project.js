...
class Project extends EE {
    ...
    .then((found) => {
      ...
      return this.watchers.watchTree(cfg.pluginsFile, {
        onChange: () => {
          ...
          this.server.onConfigurationChange(cfg.pluginsFile)
  ...
  watchSettings (onSettingsChanged, options) {
    ...
    const obj = {
      onChange: (filePath, stats) => {
        ...
        // emit the change to the runner
        this.server.onConfigurationChange(filePath)

        // call our callback function
        // when settings change!
        onSettingsChanged.call(this, filePath)
      },
    }
  ...
  watchSettingsAndStartWebsockets (options = {}, cfg = {}) {
    ...
    this.server.startWebsockets(this.automation, cfg, {
      ...
      onReloadConfiguration: options.onReloadConfiguration,
