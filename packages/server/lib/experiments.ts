...
const _summaries: StringValues = {
  ...
  experimentalUseDefaultDocumentDomain: 'Disables setting document.domain to the document\'s super domain on injection.',
...
const _names: StringValues = {
  ...
  experimentalUseDefaultDocumentDomain: 'Use Default document.domain',
