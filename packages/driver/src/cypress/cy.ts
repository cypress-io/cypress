...
import * as $Chai from '../cy/chai'
import * as $Xhrs from '../cy/xhrs'
import * as $jQuery from '../cy/jquery'
import * as $Aliases from '../cy/aliases'
import * as $Events from './events'
import * as $Ensures from '../cy/ensures'
import * as $Focused from '../cy/focused'
import * as $Mouse from '../cy/mouse'
import * as $Keyboard from '../cy/keyboard'
import * as $Location from '../cy/location'
import * as $Assertions from '../cy/assertions'
import * as $Listeners from '../cy/listeners'
import * as $Chainer from './chainer'
import * as $Timers from '../cy/timers'
import * as $Timeouts from '../cy/timeouts'
import * as $Retries from '../cy/retries'
import * as $Stability from '../cy/stability'
import * as $selection from '../dom/selection'
import * as $Snapshots from '../cy/snapshots'
import * as $Command from './command'
import * as $CommandQueue from './command_queue'
import * as $VideoRecorder from '../cy/video-recorder'
import * as $TestConfigOverrides from '../cy/testConfigOverrides'
...
export const create = function (specWindow, Cypress, Cookies, state, config, log) {
  let cy = new $Cy()
  const commandFns = {}
