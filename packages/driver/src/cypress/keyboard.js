...
var $Keyboard = {
  ...
  specialChars: {
    ...
    "{home}"(el, options) {
      ...
      options.input     = false;
      options.setKey    = "{home}";
      return this.ensureKey(el, null, options, () => $selection.moveCursorToLineStart(el));
    },
    ...
    "{end}"(el, options) {
      ...
      options.input     = false;
      options.setKey    = "{end}";
      return this.ensureKey(el, null, options, () => $selection.moveCursorToLineEnd(el));
    },
  ...
  simulateKey(el, eventType, key, options) {
    ...
    switch (eventType) {
      ...
      case "keypress":
        var asciiCode = options.charCode != null ? options.charCode : this.getAsciiCode(key);
