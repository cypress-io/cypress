...
module.exports = function(Commands, Cypress, cy, state, config) {
  ...
  const invokeItsFn = (subject, str, userOptions, ...args) => invokeBaseFn(userOptions || { log: true }, subject, str, ...args);

  const invokeFn = function(subject, userOptionsOrStr, ...args) {
  ...
  var invokeBaseFn = function(userOptions, subject, str, ...args) {
    //# name could be invoke or its!
    let resolveValue;
    const name = state("current").get("name");
