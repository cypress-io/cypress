...
export default function (Commands, Cypress, cy, state, config) {
  ...
  if (!Cypress.config('experimentalSessionAndOrigin') && Cypress.config('testIsolation')) {
    ...
    Cypress.on('test:before:run:async', () => {
      // TODO: once experimentalSessionAndOrigin is made GA, remove this logic. Leave clearing
