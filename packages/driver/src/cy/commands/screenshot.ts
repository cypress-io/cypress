...
const automateScreenshot = (state: StateFunc, options: TakeScreenshotOptions) => {
  ...
  // browser was launched with is a placeholder ("All E2E Specs"). Determine
  // the actual spec each screenshot belongs to from the runnable's invocation
  ...
  const specName = Cypress.spec.relative === RUN_ALL_SPECS_KEY
