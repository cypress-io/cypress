...
//# the outside world
{
  return (val, message) => //# make the assertion
  {
...
const overrideAssertionAssert = function (Assertion, assertFn) {
...
const useChaiJquery = (chai) => {
  return $chaiJquery(chai, chai.util, {
