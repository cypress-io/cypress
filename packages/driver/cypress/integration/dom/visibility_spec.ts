...
\`<div style="position: fixed; bottom: 0; left: 0">on top</div>\``)
  ...
  context('shadow dom', () => {
    beforeEach(function () {
      cy.state('window').customElements.define('shadow-root', class extends cy.state('window').HTMLElement {
        constructor () {
          super()
      ...
      const add = (el, shadowEl, rootIdentifier) => {
        const element = $(el).appendTo(cy.$$('body'))
      ...
      this.$outsideParentVisHidden = add(
      ...
      this.$outsideParentVisCollapse = add(
        `<table>
          <tr>
            <td>Naruto</td>
      ...
      this.$outsideParentNoHeight = add(
      ...
      this.$descendentPosAbsOutside = add(
        `<div style='width: 0; height: 100px; overflow: hidden;'>
          <div style='height: 500px; width: 500px; position: absolute;'>
      ...
      this.$descendentPosAbsInside = add(
        `<div style='width: 0; height: 100px; overflow: hidden;'>
      ...
      this.$descendentPosFixedOutside = add(
        `<div style='width: 0; height: 100px; overflow: hidden;'>
          <div style='height: 500px; width: 500px; position: fixed; top: 0; right: 0;'>
      ...
      this.$descendentPosFixedInside = add(
        `<div style='width: 0; height: 100px; overflow: hidden;'>
      ...
      this.$coveredUpByOutsidePosFixed = add(
        `<div>
      ...
      this.$coveredUpByShadowPosFixed = add(
        `<div>
      ...
      this.$elOutOfAncestorOverflowAutoBoundsOutside = add(
        `<div style='width: 100px; height: 100px; overflow: auto;'>
          <div style='width: 1000px; position: relative;'>
      ...
      this.$elOutOfAncestorOverflowAutoBoundsInside = add(
        `<div style='width: 100px; height: 100px; overflow: auto;'>
      ...
      this.$elOutOfPosAbsParentBounds = add(
        `<div style='width: 100px; height: 100px; overflow: hidden; position: relative; top: 700px; left: 700px;'>
          <div style='position: absolute;'>
      ...
      this.$elIsOutOfBoundsOfOutsideAncestorsOverflowButWithinRelativeAncestor = add(
        `<div style='padding: 100px; position: relative;'>
          <div style='overflow: hidden;'>
            <div>
      ...
      this.$elIsOutOfBoundsOfInsideAncestorsOverflowButWithinRelativeAncestor = add(
        `<div style='padding: 100px; position: relative;'>
      ...
      this.$insideParentOutOfBoundsButElInBounds = add(
        `<div style='position: relative; padding: 20px;'>
          <div style='overflow: hidden;'>
      ...
      this.$outsideParentOutOfBoundsButElInBounds = add(
        `<div style='position: relative; padding: 20px;'>
          <div style='overflow: hidden;'>
            <div style='position: relative; left: 0; top: -100px;'>
      ...
      this.$ancestorInsideTransformMakesElOutOfBoundsOfAncestor = add(
        `<div style='margin-left: 100px; overflow: hidden; width: 100px;'>
      ...
      this.$ancestorOutsideTransformMakesElOutOfBoundsOfAncestor = add(
        `<div style='margin-left: 100px; overflow: hidden; width: 100px;'>
          <div style='transform: translateX(-100px); width: 200px;'>
    ...
    describe('css visibility', () => {
      it('is hidden if parent is shadow root and has .css(visibility) hidden', function () {
        cy.wrap(this.$shadowRootVisHidden).find('button', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$shadowRootVisHidden).find('button', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden if parent outside of shadow dom has .css(visibility) hidden', function () {
        cy.wrap(this.$outsideParentVisHidden).find('button', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$outsideParentVisHidden).find('button', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden if parent outside of shadow dom has visibility collapse', function () {
        cy.wrap(this.$outsideParentVisCollapse).find('#collapse-span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$outsideParentVisCollapse).find('#collapse-span', { includeShadowDom: true }).should('not.be.visible')
      })
    })

    describe('width and height', () => {
      it('is visible if parent is shadow root and has overflow: hidden and no width', function () {
        cy.wrap(this.$shadowRootNoWidth).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$shadowRootNoWidth).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is hidden if parent outside of shadow dom has overflow: hidden and no width', function () {
        cy.wrap(this.$outsideParentNoWidth).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$outsideParentNoWidth).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is visible if parent is shadow root and has overflow: hidden and no height', function () {
        cy.wrap(this.$shadowRootNoHeight).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$shadowRootNoHeight).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is hidden if parent outside of shadow dom has overflow: hidden and no height', function () {
        cy.wrap(this.$outsideParentNoHeight).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$outsideParentNoHeight).find('span', { includeShadowDom: true }).should('not.be.visible')
      })
    })

    describe('css position', () => {
      it('is visible if child has position: absolute', function () {
        cy.wrap(this.$childPosAbs).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$childPosAbs).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible if child has position: fixed', function () {
        cy.wrap(this.$childPosFixed).find('button', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$childPosFixed).find('button', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible if descendent from parent has position: absolute and descendent is outside shadow dom', function () {
        cy.wrap(this.$descendentPosAbsOutside).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$descendentPosAbsOutside).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible if descendent from parent has position: absolute and descendent is inside shadow dom', function () {
        cy.wrap(this.$descendentPosAbsInside).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$descendentPosAbsInside).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible if descendent from parent has position: fixed and descendent is outside shadow dom', function () {
        cy.wrap(this.$descendentPosFixedOutside).find('button', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$descendentPosFixedOutside).find('button', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible if descendent from parent has position: fixed and descendent is inside shadow dom', function () {
        cy.wrap(this.$descendentPosFixedInside).find('button', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$descendentPosFixedInside).find('button', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is hidden if position: fixed and covered by element outside of shadow dom', function () {
        cy.wrap(this.$coveredUpByOutsidePosFixed).find('#inside-underneath', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$coveredUpByOutsidePosFixed).find('#inside-underneath', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden if outside of shadow dom with position: fixed and covered by element inside of shadow dom', function () {
        cy.wrap(this.$coveredUpByShadowPosFixed).find('#outside-underneath', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$coveredUpByShadowPosFixed).find('#outside-underneath', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is visible if position: fixed and parent outside shadow dom has pointer-events: none', function () {
        cy.wrap(this.$parentPointerEventsNone).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$parentPointerEventsNone).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is hidden if covered when position: fixed and parent outside shadow dom has pointer-events: none', function () {
        cy.wrap(this.$parentPointerEventsNoneCovered).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$parentPointerEventsNoneCovered).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is visible if pointer-events: none and parent outside shadow dom has position: fixed', function () {
        cy.wrap(this.$childPointerEventsNone).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$childPointerEventsNone).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })
    })

    describe('css overflow', () => {
      it('is hidden when parent outside of shadow dom overflow hidden and out of bounds to left', function () {
        cy.wrap(this.$elOutOfParentBoundsToLeft).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfParentBoundsToLeft).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent outside of shadow dom overflow hidden and out of bounds to right', function () {
        cy.wrap(this.$elOutOfParentBoundsToRight).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfParentBoundsToRight).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent outside of shadow dom overflow hidden and out of bounds above', function () {
        cy.wrap(this.$elOutOfParentBoundsAbove).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfParentBoundsAbove).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent outside of shadow dom overflow hidden and out of bounds below', function () {
        cy.wrap(this.$elOutOfParentBoundsBelow).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfParentBoundsBelow).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent outside of shadow dom overflow hidden-y and out of bounds', function () {
        cy.wrap(this.$elOutOfParentWithOverflowYHiddenBounds).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfParentWithOverflowYHiddenBounds).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent outside of shadow dom overflow hidden-x and out of bounds', function () {
        cy.wrap(this.$elOutOfParentWithOverflowXHiddenBounds).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfParentWithOverflowXHiddenBounds).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is visible when parent overflow hidden but el in a closer parent outside of shadow dom with position absolute', function () {
        cy.wrap(this.$elOutOfParentWithOverflowHiddenBoundsButCloserPositionAbsoluteParent).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$elOutOfParentWithOverflowHiddenBoundsButCloserPositionAbsoluteParent).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is hidden when parent is wide and ancestor outside shadow dom is overflow auto', function () {
        cy.wrap(this.$elOutOfAncestorOverflowAutoBoundsOutside).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfAncestorOverflowAutoBoundsOutside).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent is wide and ancestor inside shadow dom is overflow auto', function () {
        cy.wrap(this.$elOutOfAncestorOverflowAutoBoundsInside).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfAncestorOverflowAutoBoundsInside).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent outside of shadow dom has overflow scroll and out of bounds', function () {
        cy.wrap(this.$elOutOfScrollingParentBounds).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfScrollingParentBounds).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when parent absolutely positioned and overflow hidden and out of bounds', function () {
        cy.wrap(this.$elOutOfPosAbsParentBounds).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elOutOfPosAbsParentBounds).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is visible when parent absolutely positioned and overflow hidden and not out of bounds', function () {
        cy.wrap(this.$elInPosAbsParentsBounds).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$elInPosAbsParentsBounds).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible when parent overflow hidden and not out of bounds', function () {
        cy.wrap(this.$elInParentBounds).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$elInParentBounds).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible when ancestor outside shadow dom is overflow hidden but more distant ancestor is the offset parent', function () {
        cy.wrap(this.$elIsOutOfBoundsOfOutsideAncestorsOverflowButWithinRelativeAncestor).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$elIsOutOfBoundsOfOutsideAncestorsOverflowButWithinRelativeAncestor).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible when ancestor inside shadow dom is overflow hidden but more distant ancestor is the offset parent', function () {
        cy.wrap(this.$elIsOutOfBoundsOfInsideAncestorsOverflowButWithinRelativeAncestor).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$elIsOutOfBoundsOfInsideAncestorsOverflowButWithinRelativeAncestor).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is hidden when relatively positioned outside of ancestor outside shadow dom with overflow hidden', function () {
        cy.wrap(this.$elIsRelativeAndOutOfBoundsOfAncestorOverflow).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$elIsRelativeAndOutOfBoundsOfAncestorOverflow).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is visible when relatively positioned outside of ancestor outside shadow dom that does not hide overflow', function () {
        cy.wrap(this.$elIsRelativeAndOutOfBoundsOfAncestorButAncestorShowsOverflow).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$elIsRelativeAndOutOfBoundsOfAncestorButAncestorShowsOverflow).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible when parent inside shadow dom is relatively positioned out of bounds but el is relatively positioned back in bounds', function () {
        cy.wrap(this.$insideParentOutOfBoundsButElInBounds).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$insideParentOutOfBoundsButElInBounds).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is visible when parent outside shadow dom is relatively positioned out of bounds but el is relatively positioned back in bounds', function () {
        cy.wrap(this.$outsideParentOutOfBoundsButElInBounds).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$outsideParentOutOfBoundsButElInBounds).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })
    })

    describe('css transform', () => {
      it('is hidden when outside parent outside of shadow dom transform scale', function () {
        cy.wrap(this.$parentWithTransformScaleElOutsideScale).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$parentWithTransformScaleElOutsideScale).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is visible when inside parent outside of shadow dom transform scale', function () {
        cy.wrap(this.$parentWithTransformScaleElInsideScale).find('span', { includeShadowDom: true }).should('be.visible')
        cy.wrap(this.$parentWithTransformScaleElInsideScale).find('span', { includeShadowDom: true }).should('not.be.hidden')
      })

      it('is hidden when out of ancestor bounds due to ancestor within shadow dom transform', function () {
        cy.wrap(this.$ancestorInsideTransformMakesElOutOfBoundsOfAncestor).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$ancestorInsideTransformMakesElOutOfBoundsOfAncestor).find('span', { includeShadowDom: true }).should('not.be.visible')
      })

      it('is hidden when out of ancestor bounds due to ancestor outside shadow dom transform', function () {
        cy.wrap(this.$ancestorOutsideTransformMakesElOutOfBoundsOfAncestor).find('span', { includeShadowDom: true }).should('be.hidden')
        cy.wrap(this.$ancestorOutsideTransformMakesElOutOfBoundsOfAncestor).find('span', { includeShadowDom: true }).should('not.be.visible')
      })
    })
  })
})
