  ...
  context('#location', () => {
    it('returns the location object', () => {
      cy.location().then((loc) => {
        expect(loc).to.have.keys(['auth', 'authObj', 'hash', 'href', 'host', 'hostname', 'origin', 'pathname', 'port', 'protocol', 'search', 'origin', 'superDomainOrigin', 'superDomain', 'toString'])
      })
    })
    ...
    describe('.log', () => {
      ...
      it('#consoleProps', () => {
        cy.location().then(function () {
          ...
          expect(_.keys(consoleProps.Yielded)).to.deep.eq(['auth', 'authObj', 'hash', 'href', 'host', 'hostname', 'origin', 'pathname', 'port', 'protocol', 'search', 'origin', 'superDomainOrigin', 'superDomain', 'toString'])
        })
      })
    })
  })
