    ...
    describe('.log', () => {
      ...
      it('#consoleProps', () => {
        cy.location().then(function () {
          ...
          expect(_.keys(consoleProps.Yielded)).to.deep.eq(['auth', 'authObj', 'hash', 'href', 'host', 'hostname', 'pathname', 'port', 'protocol', 'search', 'origin', 'superDomainOrigin', 'superDomain', 'toString'])
        })
      })
    })
  })
