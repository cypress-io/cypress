...
describe('misc cookie tests', () => {
  ...
  it('does not duplicate cookies with a prepended dot for cookies that are stored inside the server side cookie jar', () => {
    cy.visit('https://www.foobar.com:3502/fixtures/duplicate-hostOnly-cookie.html')
