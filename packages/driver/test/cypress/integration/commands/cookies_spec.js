...
`
    ...
    return describe(".log", function() {
      ...
      it("snapshots immediately", () => cy.setCookie("foo", "bar").then(function() {
        const {
          lastLog
        } = this;
  ...
  context("#clearCookie", function() {
    ...
    return describe(".log", function() {
      ...
      it("snapshots immediately", () => cy.clearCookie("foo").then(function() {
        const {
          lastLog
        } = this;
  ...
  return context("#clearCookies", function() {
    ...
    describe(".log", function() {
      ...
      it("snapshots immediately", () => cy.clearCookies().then(function() {
        const {
          lastLog
        } = this;
