...
describe('src/cy/commands/screenshot', function () {
  ...
  context('runnable:after:run:async hooks', function () {
    ...
    return it('takes screenshot of hook title with test', () => {})
  })
  ...
  return context('#screenshot', function () {
    ...
    it('sends viewport dimensions of main browser window', function () {
      ...
      .screenshot()
      .then(() => {
        return expect(Cypress.automation.withArgs('take:screenshot').args[0][1].viewport).to.eql({
    ...
    describe('capture: fullPage', function () {
      ...
      return it('sends the right clip values', () => {
        return cy.screenshot({ capture: 'fullPage' })
        .then(() => {
          const take = Cypress.automation.withArgs('take:screenshot')
    ...
    describe('element capture', function () {
      ...
      it('works with cy.within()', () => {
        return cy.get('.short-element').within(() => cy.screenshot()).then(() => {
          const take = Cypress.automation.withArgs('take:screenshot')
      ...
      return it('passes through document', () => {
        return cy
        .document()
        .then((doc) => {
          return cy.wrap(doc)
    ...
    return describe('.log', function () {
      ...
      it('can turn off logging', () => {
        return cy.screenshot('bar', { log: false }).then(function () {
