...
describe("src/cy/commands/agents", function() {
  context(".stub", function() {
    it("synchronously returns stub", function() {
      const stub = cy.stub();
    ...
    describe(".stub(obj, 'method')", function() {
      beforeEach(function() {
        ...
        this.obj = {
          foo: () => { return this.originalCalled = true; }
        };
        return this.stub = cy.stub(this.obj, "foo");
      });
      ...
      return it("can callThrough on constructors", function() {
    ...
    describe(".stub(obj, 'method', replacerFn)", function() {
      beforeEach(function() {
        ...
        return this.stub = cy.stub(this.obj, "foo", () => {
          return this.replacementCalled = true;
        });
      });
    ...
    describe(".resolves", function() {
      ...
      return it("uses Bluebird under the hood", function() {
        const obj = {
          foo() {}
        };
    ...
    describe(".rejects", function() {
      ...
      return it("rejects promise", function() {
        ...
        return this.obj.foo()
        .then(function() {
          throw new Error("Should throw error");}).catch(err => expect(err).to.eq(error));
      });
    });
    ...
    describe(".withArgs", function() {
      beforeEach(function() {
        ...
        return this.stubWithArgs = this.stub.withArgs("foo");
      });
        ...
        return describe("on invocation", function() {
          ...
          return describe(".consoleProps", function() {
            beforeEach(function() {
              ...
              return this.consoleProps = this.logs[4].get("consoleProps")();
            });
    ...
    describe(".as", function() {
      context("without dots", function() {
        beforeEach(function() {
          ...
          return this.stub = cy.stub().as("myStub");
        });
      ...
      return context("with dots", function() {
        beforeEach(function() {
          ...
          return this.stub = cy.stub().as("my.stub");
        });
    ...
    return describe("logging", function() {
      beforeEach(function() {
        ...
        this.obj = {foo() {}};
        return this.stub = cy.stub(this.obj, "foo").returns("return value");
      });
...
`);
      ...
      return context("#consoleProps", function() {
        beforeEach(function() {
          ...
          this.obj.foo("foo", "baz");
          return this.consoleProps = this.logs[1].get("consoleProps")();
        });
  ...
  context(".spy(obj, 'method')", function() {
    beforeEach(function() {
      ...
      this.obj = {
        foo: () => {
          return this.originalCalled = true;
        }
      };
      return this.spy = cy.spy(this.obj, "foo");
    });
    ...
    it("can spy on constructors", function() {
    ...
    context("#as", function() {
      ...
      beforeEach(function() {
        ...
        return this.spy = cy.spy().as("mySpy");
      });
