...
describe("driver/src/cy/snapshots", function() {
  context("invalid snapshot html", function() {
    beforeEach(() => cy.visit("/fixtures/invalid_html.html"));

    return it("can snapshot html with invalid attributes", function() {
  ...
  context("snapshot no html/doc", function() {
    beforeEach(() => cy.visit("/fixtures/no_html.html"));

    return it("does not err on snapshot", function() {
      const { htmlAttrs } = cy.createSnapshot();
  ...
  return context("snapshot el", function() {
    ...
    beforeEach(function() {
      ...
      return this.$el = $("<span id='snapshot'>snapshot</span>").appendTo(cy.$$("body"));
    });
