...
describe("src/cypress/dom/visibility", function() {
  beforeEach(() => cy.visit("/fixtures/generic.html"));

  context("isHidden", function() {
    it("exposes isHidden", () => expect($dom.isHidden).to.be.a("function"));

    return it("throws when not passed a DOM element", function() {
      const fn = () => $dom.isHidden(null);

      return expect(fn).to.throw("Cypress.dom.isHidden() failed because it requires a DOM element. The subject received was: \'null\'");
    });
  });

  context("isVisible", function() {
    it("exposes isVisible", () => expect($dom.isVisible).to.be.a("function"));

    return it("throws when not passed a DOM element", function() {
      const fn = () => $dom.isVisible("form");

      return expect(fn).to.throw("Cypress.dom.isVisible() failed because it requires a DOM element. The subject received was: \'form\'");
    });
  });

  context("#isScrollable", function() {
    beforeEach(function() {
      return this.add = el => {
    ...
    it("returns true if window and body > window height", function() {
      ...
      const fn = () => $dom.isScrollable(win);

      return expect(fn()).to.be.true;
    });

    it("returns false window and body > window height", function() {
...
`
      ...
      const fn = () => $dom.isScrollable(noScroll);
...
`
      ...
      const fn = () => $dom.isScrollable(noOverflow);
...
`
      ...
      const fn = () => $dom.isScrollable(vertScrollable);
...
`
      ...
      const fn = () => $dom.isScrollable(horizScrollable);

      return expect(fn()).to.be.true;
    });

    return it("returns true when overflow scroll forced and content larger", function() {
...
`
      ...
      const fn = () => $dom.isScrollable(forcedScroll);

      return expect(fn()).to.be.true;
    });
  });

  return context("hidden/visible overrides", function() {
    beforeEach(function() {
      const add = el => {
        return $(el).appendTo(cy.$$("body"));
      };
...
`
      ...
      return scrollThisIntoView.get(1).scrollIntoView();
    });

    describe("html or body", function() {
      it("is visible if html", function() {
        ...
        return cy.wrap(cy.$$("html")).should("be.visible");
      });

      it("is visible if body", function() {
        ...
        return cy.wrap(cy.$$("body")).should("be.visible");
      });

      return it("is visible if display none on body or html", function() {
        ...
        expect(cy.$$("body")).not.to.be.hidden;
        return expect(cy.$$("body")).to.be.visible;
      });
    });

    describe("css visibility", function() {
      it("is hidden if .css(visibility) is hidden", function() {
        ...
        return cy.wrap(this.$visHidden).should("not.be.visible");
      });
      ...
      it("is hidden if parents have .css(visibility) hidden", function() {
        ...
        return cy.wrap(this.$parentVisHidden).find("button").should("not.be.visible");
      });
      ...
      it("is hidden if visibility collapse", function() {
        ...
        return expect(this.$tableVisCollapse.find("tr.collapse td")).to.not.be.visible;
      });  
      ...
      it("is hidden if parent has visibility collapse", function() {
        ...
        return expect(this.$tableVisCollapse.find("#collapse-span")).to.not.be.visible;
      });  

      return it("is hidden if input type hidden", function() {
        ...
        return cy.wrap(this.$inputHidden).should("not.be.visible");
      });
    });

    describe("option and optgroup", function() {
      it("is visible if option in visible select", function() {
        ...
        return cy.wrap(this.$optionInSelect.find('option')).should("be.visible");
      });
      ...
      it("is visible if optgroup in visible select", function() {
        ...
        return cy.wrap(this.$optgroupInSelect.find('optgroup')).should("be.visible");
      });
      ...
      it("is hidden if option in hidden select", function() {
        ...
        return cy.wrap(this.$optionInHiddenSelect.find('option')).should("not.be.visible");
      });
      ...
      it("is hidden if option is display none", function() {
        ...
        return cy.wrap(this.$optionHiddenInSelect.find('#hidden-opt')).should("not.be.visible");
      });

      return it("follows regular visibility logic if option outside of select", function() {
        ...
        return cy.wrap(this.$optionOutsideSelect.find('#option-visible')).should("be.visible");
      });
    });
    ...
    describe("opacity visible", () =>
      it("is visible if opacity is 0", function() {
        ...
        return cy.wrap(this.$btnOpacity).should("be.visible");
      })
    );
    ...
    describe("css position", function() {
      ...
      it("is visible if descendent from parent has position: fixed", function() {
        ...
        return expect(this.$descendentPosFixed.find("button")).not.to.be.hidden;
      });
      ...
      it("is visible if descendent from parent has position: absolute", function() {
        ...
        return expect(this.$descendentPosAbs.find("span")).to.not.be.hidden;
      });

      return it("is hidden if only the parent has position absolute", function() {
        expect(this.$parentPosAbs.find("span")).to.be.hidden;
        return expect(this.$parentPosAbs.find("span")).to.not.be.visible;
      });
    });

    describe("css overflow", function() {
      it("is visible when parent doesnt have overflow hidden", function() {
        ...
        return expect(this.$parentNoWidthHeightOverflowAuto.find("span")).to.not.be.hidden;
      });

      it("is hidden when parent overflow hidden and out of bounds to left", function() {
        return expect(this.$elOutOfParentBoundsToLeft.find("span")).to.be.hidden;
      });

      it("is hidden when parent overflow hidden and out of bounds to right", function() {
        return expect(this.$elOutOfParentBoundsToRight.find("span")).to.be.hidden;
      });

      it("is hidden when parent overflow hidden and out of bounds above", function() {
        return expect(this.$elOutOfParentBoundsAbove.find("span")).to.be.hidden;
      });

      it("is hidden when parent overflow hidden and out of bounds below", function() {
        return expect(this.$elOutOfParentBoundsBelow.find("span")).to.be.hidden;
      });

      it("is hidden when parent overflow-y hidden and out of bounds", function() {
        return expect(this.$elOutOfParentWithOverflowYHiddenBounds.find("span")).to.be.hidden;
      });

      it("is hidden when parent overflow-x hidden and out of bounds", function() {
        return expect(this.$elOutOfParentWithOverflowXHiddenBounds.find("span")).to.be.hidden;
      });

      it("is visible when parent overflow hidden but el in a closer parent with position absolute", function() {
        return expect(this.$elOutOfParentWithOverflowHiddenBoundsButCloserPositionAbsoluteParent.find("span")).to.be.visible;
      });
      ...
      it("is hidden when parent flex and overflow hidden and el out of bounds", function() {
        ...
        return expect(this.$elOutOfParentWithFlexAndOverflowHiddenBounds.find("#blue")).to.be.hidden;
      });

      it("is hidden when parent is wide and ancestor is overflow auto", function() {
        return expect(this.$elOutOfAncestorOverflowAutoBounds.find("span")).to.be.hidden;
      });

      it("is hidden when parent overflow scroll and out of bounds", function() {
        return expect(this.$elOutOfScrollingParentBounds.find("span")).to.be.hidden;
      });

      it("is hidden when parent absolutely positioned and overflow hidden and out of bounds", function() {
        return expect(this.$elOutOfPosAbsParentsBounds.find("span")).to.be.hidden;
      });

      it("is visible when parent absolutely positioned and overflow hidden and not out of bounds", function() {
        return expect(this.$elInPosAbsParentsBounds.find("span")).to.be.visible;
      });

      it("is visible when parent overflow hidden and not out of bounds", function() {
        return expect(this.$elInParentBounds.find("span")).to.be.visible;
      });

      it("is visible when ancestor is overflow hidden but more distant ancestor is the offset parent", function() {
        return expect(this.$elIsOutOfBoundsOfAncestorsOverflowButWithinRelativeAncestor.find("span")).to.be.visible;
      });

      it("is hidden when relatively positioned outside ancestor with overflow hidden", function() {
        return expect(this.$elIsRelativeAndOutOfBoundsOfAncestorOverflow.find("span")).to.be.hidden;
      });

      it("is visible when el is relatively positioned outside ancestor that does not hide overflow", function() {
        return expect(this.$elIsRelativeAndOutOfBoundsOfAncestorButAncestorShowsOverflow.find("span")).to.be.visible;
      });

      return it("is visible when parent is relatively positioned out of bounds but el is relatively positioned back in bounds", function() {
        return expect(this.$parentOutOfBoundsButElInBounds.find("span")).to.be.visible;
      });
    });

    describe("css clip-path", function() {
      it.skip("is hidden when outside of parents clip-path", function() {
        return expect(this.$parentWithClipPathAbsolutePositionElOutsideClipPath.find("span")).to.be.hidden;
      });

      return it("is visible when inside of parents clip-path", function() {
        return expect(this.$parentWithClipPathAbsolutePositionElInsideClipPath.find("span")).to.be.visible;
      });
    });

    describe("css transform", function() {
      it.skip("is hidden when outside parents transform scale", function() {
        return expect(this.$parentWithTransformScaleElOutsideScale.find("span")).to.be.hidden;
      });

      it("is visible when inside of parents transform scale", function() {
        return expect(this.$parentWithTransformScaleElInsideScale.find("span")).to.be.visible;
      });
      
      it("is hidden when out of ancestor's bounds due to ancestor's transform", function() {
        return expect(this.$ancestorTransformMakesElOutOfBoundsOfAncestor.find("span")).to.be.hidden;
      });

      return it("is visible when in ancestor's bounds due to ancestor's transform", function() {
        return expect(this.$ancestorTransformMakesElInBoundsOfAncestor.find("#inbounds")).to.be.visible;
      });
    });

    describe("css backface-visibility", function() {
      it("is visible when backface not visible", function() {
        return expect(this.$parentsWithBackfaceVisibilityHidden.find("#front")).to.be.visible;
      });

      return it.skip("is hidden when backface visible", function() {
        return expect(this.$parentsWithBackfaceVisibilityHidden.find("#back")).to.be.hidden;
      });
    });

    return describe("#getReasonIsHidden", function() {
      beforeEach(function() {
        return this.reasonIs = ($el, str) => expect($dom.getReasonIsHidden($el)).to.eq(str);
      });

      it("has 'display: none'", function() {
        return this.reasonIs(this.$displayNone, "This element '<button>' is not visible because it has CSS property: 'display: none'");
      });

      it("has a parent with 'display: none'", function() {
        return this.reasonIs(this.$parentDisplayNone.find("span"), "This element '<span>' is not visible because its parent '<div#none>' has CSS property: 'display: none'");
      });

      it("has 'visibility: hidden'", function() {
        return this.reasonIs(this.$visHidden, "This element '<ul>' is not visible because it has CSS property: 'visibility: hidden'");
      });

      it("has parent with 'visibility: hidden'", function() {
        return this.reasonIs(this.$parentVisHidden.find("button"), "This element '<button>' is not visible because its parent '<div.invis>' has CSS property: 'visibility: hidden'");
      });

      it("has 'visibility: collapse'", function() {
        return this.reasonIs(this.$tableVisCollapse.find("td.collapse"), "This element '<td.collapse>' is not visible because it has CSS property: 'visibility: collapse'");
      });

      it("has parent with 'visibility: collapse'", function() {
        return this.reasonIs(this.$tableVisCollapse.find("tr.collapse td:first"), "This element '<td>' is not visible because its parent '<tr.collapse>' has CSS property: 'visibility: collapse'");
      });

      it("is detached from the DOM", function() {
        return this.reasonIs(this.$divDetached, "This element '<div>' is not visible because it is detached from the DOM");
      });

      it("has effective zero width", function() {
        return this.reasonIs(this.$divNoWidth, "This element '<div>' is not visible because it has an effective width and height of: '0 x 100' pixels.");
      });

      it("has effective zero height", function() {
        return this.reasonIs(this.$divNoHeight, "This element '<div>' is not visible because it has an effective width and height of: '50 x 0' pixels.");
      });

      it("has a parent with an effective zero width and overflow: hidden", function() {
        return this.reasonIs(this.$parentNoHeight.find("span"), "This element '<span>' is not visible because its parent '<div>' has CSS property: 'overflow: hidden' and an effective width and height of: '100 x 0' pixels.");
      });

      it("element sits outside boundaries of parent with overflow clipping", function() {
        return this.reasonIs(this.$elOutOfParentBoundsToRight.find("span"), "This element '<span>' is not visible because its content is being clipped by one of its parent elements, which has a CSS property of overflow: \'hidden\', \'scroll\' or \'auto\'");
      });

      it("element is fixed and being covered", function() {
        return this.reasonIs(this.$coveredUpPosFixed.find("#coveredUpPosFixed"), `\
...
`
      ...
      return it("cannot determine why element is not visible", function() {
        return this.reasonIs(this.$btnOpacity, "Cypress could not determine why this element '<button>' is not visible.");
      });
    });
  });
});
