...
// @ts-ignore
let _ = require('lodash') as LoDashStatic
// @ts-ignore
...
const matchDeep = function (matchers, exp, optsArg:object) {
  let m = matchers
...
const withMatchers = (matchers:object, match:sinon.SinonMatch, onlyExpected: boolean) => {
