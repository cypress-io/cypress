...
let jquery = createCommonjsModule(function (module) {
...
// "use strict";
  ...
  let attrFn = jQuery('<input/>', { size: 1 }).attr('size') && jQuery.attrFn,
    oldAttr = jQuery.attr,
  ...
  jQuery.sub = function () {
    ...
    jQuerySub.fn.init = function init (selector, context) {
      let instance = jQuery.fn.init.call(this, selector, context, rootjQuerySub)
  ...
  if (jQuery.swap) {
    jQuery.each(['height', 'width', 'reliableMarginRight'], function (_, name) {
      let oldHook = jQuery.cssHooks[ name ] && jQuery.cssHooks[ name ].get
  ...
  jQuery.fn.find = function (selector) {
    let ret = oldFnFind.apply(this, arguments)
  ...
  if (jQuery.Callbacks) {
    ...
    let oldDeferred = jQuery.Deferred,
      tuples = [
