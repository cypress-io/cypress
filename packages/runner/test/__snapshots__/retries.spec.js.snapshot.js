...
exports['src/cypress/runner isolated test runner other specs screenshots retries retry screenshot in test body #1'] = [
  "take:screenshot",
  {
    "titles": [
      "suite 1",
...
exports['src/cypress/runner isolated test runner other specs screenshots retries retry screenshot in test body #2'] = {
  "id": "r3",
  "testAttemptIndex": "match.match(0)",
  "isOpen": false,
  "appOnly": true,
