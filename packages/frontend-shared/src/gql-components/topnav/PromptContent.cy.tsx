...
describe('<PromptContent />', { viewportWidth: 500, viewportHeight: 800 }, () => {
  ...
  it('renders with expected content', () => {
    ...
    .eq(0)
    .find('a')
    .should('have.attr', 'href', 'https://on.cypress.io/setup-ci-circleci?utm_medium=CI+Prompt+1&utm_campaign=Circle&utm_content=Manual&utm_source=Binary%3ALaunchpad')

    cy.contains('a', defaultMessages.topNav.docsMenu.prompts.ci1.intro)
    .should('have.attr', 'href', 'https://on.cypress.io/ci?utm_medium=CI+Prompt+1&utm_campaign=Learn+More&utm_source=Binary%3ALaunchpad')
  })
})
