<template>
  <code class="border rounded flex font-normal border-gray-100 pl-16px pr-4px text-gray-700 leading-40px relative items-center whitespace-nowrap overflow-hidden w-full">
