...
export type AuthFragment = { readonly __typename?: 'Query', readonly cloudViewer: { readonly __typename?: 'CloudUser', readonly id: string, readonly email: string | null, readonly fullName: string | null } | null, readonly authState: { readonly __typename?: 'AuthState', readonly browserOpened: boolean, readonly name: AuthStateNameEnum | null, readonly message: string | null } };

export type Auth_LogoutMutationVariables = Exact<{ [key: string]: never; }>;


export type Auth_LogoutMutation = { readonly __typename?: 'Mutation', readonly logout: { readonly __typename?: 'Query', readonly cloudViewer: { readonly __typename?: 'CloudUser', readonly id: string, readonly email: string | null, readonly fullName: string | null } | null, readonly authState: { readonly __typename?: 'AuthState', readonly browserOpened: boolean, readonly name: AuthStateNameEnum | null, readonly message: string | null } } | null };
...
export type Auth_ResetAuthStateMutation = { readonly __typename?: 'Mutation', readonly resetAuthState: { readonly __typename?: 'Query', readonly cloudViewer: { readonly __typename?: 'CloudUser', readonly id: string, readonly email: string | null, readonly fullName: string | null } | null, readonly authState: { readonly __typename?: 'AuthState', readonly browserOpened: boolean, readonly name: AuthStateNameEnum | null, readonly message: string | null } } };
...
export type OpenConfigFileInIdeFragment = { readonly __typename?: 'CurrentProject', readonly id: string, readonly configFile: string | null, readonly configFileAbsolutePath: string | null };

export type OpenFileInIdeQueryVariables = Exact<{ [key: string]: never; }>;


export type OpenFileInIdeQuery = { readonly __typename?: 'Query', readonly localSettings: { readonly __typename?: 'LocalSettings', readonly preferences: { readonly __typename?: 'LocalSettingsPreferences', readonly preferredEditorBinary: string | null }, readonly availableEditors: ReadonlyArray<{ readonly __typename?: 'Editor', readonly id: string, readonly name: string, readonly binary: string }> } };
...
export type OpenFileInIde_MutationMutation = { readonly __typename?: 'Mutation', readonly openFileInIDE: boolean | null };
...
export type LoginModalFragment = { readonly __typename?: 'Query', readonly cloudViewer: { readonly __typename?: 'CloudUser', readonly id: string, readonly email: string | null, readonly fullName: string | null } | null, readonly authState: { readonly __typename?: 'AuthState', readonly browserOpened: boolean, readonly name: AuthStateNameEnum | null, readonly message: string | null } };
...
export type Clipboard_CopyToClipboardMutation = { readonly __typename?: 'Mutation', readonly copyTextToClipboard: boolean | null };
