...
import { subscriptionExchange, createClient, dedupExchange, errorExchange, gql } from '@urql/core'
import type { TypedDocumentNode, ExecutionResult, Client } from '@urql/core'
