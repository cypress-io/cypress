...
describe('supportFileComponent', () => {
  ...
  context('lit', () => {
    it(`handles cypress/lit and JS`, () => {
      const actual = supportFileComponent('js', 'cypress/lit')
    ...
    it(`handles cypress/lit and TS`, () => {
      const actual = supportFileComponent('ts', 'cypress/lit')
