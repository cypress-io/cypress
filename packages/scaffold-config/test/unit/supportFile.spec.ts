...
describe('supportFileComponent', () => {
  ...
  context('solid', () => {
    it(`handles cypress/solid and JS`, () => {
      const actual = supportFileComponent('js', 'cypress/solid')
    ...
    it(`handles cypress/solid and TS`, () => {
      const actual = supportFileComponent('ts', 'cypress/solid')
