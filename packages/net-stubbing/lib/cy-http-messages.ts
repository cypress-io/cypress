import type { StaticResponse } from '@packages/network-interception'
import type {
  DriverInterceptMessage,
  DriverInterceptNetworkError,
...
export namespace CyHttpMessages {
  ...
  export type IncomingResponse<T = any> = DriverInterceptResponse<T>
  ...
  export type IncomingRequest<T = any> = DriverInterceptRequest<T>
  ...
  export type ResponseComplete<T = any> = DriverInterceptResponseComplete<T>

  export type NetworkError = DriverInterceptNetworkError
}
