...
describe('app/background', () => {
  beforeEach(function (done) {
    ...
    this.server = socket.server(this.httpSrv, { path: '/__cypress/socket.io' })

    this.onConnect = (callback) => {
      const client = background.connect(`http://localhost:${PORT}`, '/__cypress/socket.io')
  ...
  context('.connect', () => {
    it('can connect', function (done) {
      ...
      return background.connect(`http://localhost:${PORT}`, '/__cypress/socket.io')
    })
  ...
  context('integration', () => {
    beforeEach(function (done) {
      ...
      this.client = background.connect(`http://localhost:${PORT}`, '/__cypress/socket.io')
    })
