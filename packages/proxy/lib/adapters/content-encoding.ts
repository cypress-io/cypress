...
/**
 * {@link ForContentEncoding} adapter for the CDP Fetch pipeline. The browser
 * owns negotiation and decoding, and fulfilled responses must be identity, so
 * both sides are intentionally inert.
 */
export class NoopContentEncodingAdapter implements ForContentEncoding {
  constrainAcceptEncoding (): void {}

  async compressBody (): Promise<void> {}
}
