...
import { endRequestsToBlockedHosts } from '../adapters/end-requests-to-blocked-hosts'
import {
...
const EndRequestsToBlockedHosts: RequestMiddleware = async function () {
  return endRequestsToBlockedHosts(this, () => this.networkInterceptionCore.runRequestPolicies(this))
}
