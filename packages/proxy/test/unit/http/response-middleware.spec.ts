...
describe('http/response-middleware', function () {
  ...
  describe('MaybeInjectServiceWorker', function () {
    ...
    it('prepends the navigation preload expression when disableServiceWorkerNavigationPreload is set on ctx', async function () {
      prepareContext({
        req: {
          proxiedUrl: 'http://www.foobar.com:3501/service-worker.js',
          headers: {
    ...
    it('does not prepend the navigation preload expression when disableServiceWorkerNavigationPreload is unset on ctx', async function () {
      prepareContext({
        req: {
          proxiedUrl: 'http://www.foobar.com:3501/service-worker.js',
          headers: {
