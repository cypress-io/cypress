...
const createIndex = (arr, keyKey, valueKey): Record<string, any> => {
...
export const validateNoBreakingConfigRoot = (cfg, onWarning, onErr): any => {
  return validateNoBreakingOptions(breakingRootOptions, cfg, onWarning, onErr)
}

export const validateNoBreakingConfig = (cfg, onWarning, onErr) => {
  return validateNoBreakingOptions(breakingOptions, cfg, onWarning, onErr)
}

export const validateNoBreakingTestingTypeConfig = (cfg, testingType, onWarning, onErr): any => {
  const options = testingTypeBreakingOptions[testingType]

  return validateNoBreakingOptions(options, cfg, onWarning, onErr)
}

export const validateNoReadOnlyConfig = (config, onErr) => {
  let errProperty
