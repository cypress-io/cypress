<template>
  ...
  >
    <template v-if="props.gql.browserErrorMessage">
      <div class="flex items-center p-4 text-center rounded min-w-200px max-w-600px mx-auto space-y-32px mt-20px bg-warning-100 text-warning-600">
