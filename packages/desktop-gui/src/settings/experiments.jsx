    ...
    <div data-cy="experiments">
      ...
      <div>
        <p className="experiment-intro">
          If you'd like to try out what we're working on, you can enable these beta features for your project by setting
          configuration using the <code>experimental</code> prefix.
        </p>
      </div>
