    ...
    <div className="node-version">
      ...
      <div>
        {usesSystemNodeVersion ? (
          ...
          <div>
            <span>
              <strong>Note:</strong> This version of Node.js is bundled with Cypress.{' '}
            </span>
            To use your system Node.js version, set{' '}
            <a href="#" onClick={openHelp}>
              <code>nodeVersion</code>
            </a>{' '}
            to <code>system</code> in your configuration.
          </div>
        )}{' '}
        <div className="well text-muted">
          ...
          <ul>
            ...
            <li>
              Build files in the <code>cypress/support</code> folder.
            </li>
