...
export const sessionLifecycle = () => {
  return `
    ...
    <div class='container'>
      ${svg_cy}
      <br/>
      <p class="warn">Because <code><b>experimentalMultiDomain</b></code> is enabled, Cypress navigates to the default blank page <span class="em">before each test</span> to ensure test reliability.</p>
      <p>This is the default blank page.</p>
      <p>To test your web application:</p>
      <ul>
        <li>Start your app's server</li>
