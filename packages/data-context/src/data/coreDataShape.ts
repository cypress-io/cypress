...
import { WizardBundler, ResolvedComponentFrameworkDefinition, CT_FRAMEWORKS, resolveComponentFrameworkDefinition, solidJs } from '@packages/scaffold-config'
...
export function makeCoreData (modeOptions: Partial<AllModeOptions> = {}): CoreDataShape {
  return {
    ...
    wizard: {
      ...
      frameworks: [...CT_FRAMEWORKS, solidJs].map((framework) => resolveComponentFrameworkDefinition(framework)),
    },
    migration: {
      step: 'renameAuto',
