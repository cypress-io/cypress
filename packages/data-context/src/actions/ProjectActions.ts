...
import type { RunSpecErrorCode } from '../../graphql/schemaTypes'
...
export interface ProjectApiShape {
  ...
  getRemoteStates(): {
    reset(): void
    getPrimary(): Cypress.RemoteState | undefined
    waitForPrimary(timeoutMs?: number): Promise<Cypress.RemoteState>
  } | undefined
