...
const EditorPickerModal = observer(
  ({ chosenEditor, editors, isOpen, onClose, onSetChosenEditor, onSetEditor }: Props) => {
    ...
    return (
      ...
      >
        <div className="content">
          ...
          />
          <p>
            We will use your selected preference to open files in the future. You can change your preference in the{' '}
            <b>Settings</b> tab of the Cypress Test Runner.
          </p>
        </div>
        <div className="controls">
          <Tooltip title={validationMessage} visible={isValid ? false : undefined} className="cy-tooltip">
            <button className={cs('submit', { 'is-disabled': !isValid })} onClick={setEditor}>
